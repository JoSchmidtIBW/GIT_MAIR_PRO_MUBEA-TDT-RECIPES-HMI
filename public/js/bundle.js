...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // afterbegin = body, equal start
...
var dev_Port = 8555;
var prod_Port = 8557;
var port = "development" === 'development' ? dev_Port : prod_Port;
var host = 'http://127.0.0.1:';
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(employeeNumber, password) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('Bin login von login.js: ' + employeeNumber, password);
          _context.prev = 1;
          _context.next = 4;
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1500);
          }
          _context.next = 13;
          break;
        case 8:
          ...
          console.log(JSON.stringify(_context.t0.response.data) + ' bin Err login in login.js');
          console.log(JSON.stringify(_context.t0.response.data.message) + ' bin Err login in login.js');
          if (_context.t0.response.data.message === "Cannot read properties of null (reading 'password')") {
            (0, _alerts.showAlert)('error', JSON.stringify(_context.t0.response.data.message) + ' employeeNumber not found in db');
          } else if (_context.t0.response.data.message === 'isBcrypt is not defined') {
            (0, _alerts.showAlert)('error', JSON.stringify(_context.t0.response.data.message) + ' password is wrong, employeeNumber is found');
          } else {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(apiUrl, "/users/logout")
          });
        case 3:
          res = _context2.sent;
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"updateSettings.js":[function(require,module,exports) {
var define;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          url = type === 'password' ? "".concat(apiUrl, "/users/updateMyPassword") : "".concat(apiUrl, "/users/updateMe");
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 5:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/me"));
            }, 2500);
          }
          _context.next = 13;
          break;
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"sps.js":[function(require,module,exports) {
var define;
...
exports.writeRecipeToSPS_noInlogt = exports.writeRecipeToSPS = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
...
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var writeRecipeToSPS_noInlogt = exports.writeRecipeToSPS_noInlogt = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(recipeSendDataParse, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('bin writeRecipeToSPS_noInlogt zum serverschicken und habe bekommen: ' + JSON.stringify(recipeSendDataParse));
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/sps/writeRecipeToSPS"),
            data: {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _index.setRecipeSendStatus)("".concat(recipeSendDataParse.artikelNummer, " \u2192 ").concat(recipeSendDataParse.artikelName), true);
            // await new Promise((resolve) => setTimeout(resolve, 5000));
            // console.log('Executed after 5 seconds');
            // return res;

            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overview")); // über local funktioniert, weil user mit JWT angemeldet bleibt
            }, 3800);
          } else {
            console.log('Recipe not sended to plc!');
            (0, _index.setRecipeSendStatus)('Failed to send recipe to PLC', false);
            // return res;
          }
          _context.next = 12;
          break;
  ...
  return function writeRecipeToSPS_noInlogt(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var writeRecipeToSPS = exports.writeRecipeToSPS = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(recipeSendDataParse, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          console.log('bin writeRecipeToSPS zum serverschicken und habe bekommen: ' + JSON.stringify(recipeSendDataParse));
          _context2.prev = 1;
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            //return res;
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt")); // über local funktioniert, weil user mit JWT angemeldet bleibt
            }, 3800);
          } else {
            console.log('Recipe not sended to plc!');
            (0, _index.setRecipeSendStatus)('Failed to send recipe to PLC', false);
  ...
  return function writeRecipeToSPS(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js","./index.js":"index.js"}],"recipeSendSPSLog.js":[function(require,module,exports) {
var define;
...
exports.showRecipesSendSPSLogTable_de = exports.showRecipesSendSPSLogTable_cs = exports.showRecipesSendSPSLogTable = exports.showMyRecipeSendTable_de = exports.showMyRecipeSendTable_cs = exports.showMyRecipeSendTable = exports.createRecipeSendSPSLog_noInlogt = exports.createRecipeSendSPSLog = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var createRecipeSendSPSLog = exports.createRecipeSendSPSLog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(recipeSendDataParse, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('bin createRecipeSendSPSLog: zum serverschicken und habe bekommen: ', recipeSendDataParse, userSendData, fa_Nummer);
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipeSendSPSLog/createRecipeSendSPSLog"),
            data: {
              recipeData: recipeSendDataParse,
              userSendData: userSendData,
              fa_NummerData: fa_Nummer
        ...
        case 4:
          ...
          (0, _alerts.showAlert)('success', 'RecipeSendSPSLog successfully created');
  ...
  return function createRecipeSendSPSLog(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var createRecipeSendSPSLog_noInlogt = exports.createRecipeSendSPSLog_noInlogt = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(recipeSendDataParse, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          console.log('bin createRecipeSendSPSLog_noInlogt: zum serverschicken und habe bekommen: ', recipeSendDataParse, userSendData, fa_Nummer);
          _context2.prev = 1;
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'POST',
  ...
  return function createRecipeSendSPSLog_noInlogt(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
var showRecipesSendSPSLogTable = exports.showRecipesSendSPSLogTable = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(apiUrl, "/recipeSendSPSLog")
          });
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            ...
            table = $('#recipesSendSPSLogTable').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              ...
              lengthChange: true,
              lengthMenu: [[2, 5, 10, -1], [2, 5, 10, 'Alle']],
              pageLength: 5,
              columns: [{
                ...
                width: '7%',
                render: function render(data) {
                  return data ? new Date(data).toLocaleTimeString('de-DE', {
                    hour: '2-digit',
                    minute: '2-digit',
                    hour12: false
                  }) : '-';
              ...
              drawCallback: function drawCallback() {
                console.log('DataTable draw complete! Seite muss ev. 2x aktualisiert werden!');
              },
              initComplete: function initComplete() {
                $('#recipesSendSPSLogTable thead th').each(function () {
                  $(this).append('<div class="arrowUpDown"><span class="arrow-up"></span><span class="arrow-down"></span></div>'
            ...
            $('#recipesSendSPSLogTable').off('click').on('click', '.toggle-RecipeEye-button', function () {
              var index = $(this).data('index');
              var container = $("#exampleImg-RecipeEye-container-".concat(index));
              if (container.length) {
                container.toggle();
                ...
                console.error("Container mit ID exampleImg-RecipeEye-container-".concat(index, " wurde nicht gefunden."));
              }
            });
        ...
        case 8:
          ...
          console.error('Fehler in showRecipesSendSPSLogTable:', _context3.t0);
        case 11:
        case "end":
  ...
  return function showRecipesSendSPSLogTable() {
    return _ref3.apply(this, arguments);
  };
}();
var showRecipesSendSPSLogTable_de = exports.showRecipesSendSPSLogTable_de = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            table = $('#recipesSendSPSLogTable_de').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
            ...
            $('#recipesSendSPSLogTable_de').off('click').on('click', '.toggle-RecipeEye-button', function () {
              var index = $(this).data('index');
              console.log('Click!');
              var container = $("#exampleImg-RecipeEye-container-".concat(index));
              if (container.length) {
        ...
        case 8:
          ...
          console.error('Fehler in showRecipesSendSPSLogTable_de:', _context4.t0);
        case 11:
        case "end":
  ...
  return function showRecipesSendSPSLogTable_de() {
    return _ref4.apply(this, arguments);
  };
}();
var showRecipesSendSPSLogTable_cs = exports.showRecipesSendSPSLogTable_cs = /*#__PURE__*/function () {
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            table = $('#recipesSendSPSLogTable_cs').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
              ...
              lengthChange: true,
              lengthMenu: [[2, 5, 10, -1], [2, 5, 10, 'Vše']],
              pageLength: 5,
              columns: [{
            ...
            $('#recipesSendSPSLogTable_cs').off('click').on('click', '.toggle-RecipeEye-button', function () {
              var index = $(this).data('index');
              console.log('Click!');
              var container = $("#exampleImg-RecipeEye-container-".concat(index));
              if (container.length) {
        ...
        case 8:
          ...
          console.error('Fehler in showRecipesSendSPSLogTable_cs:', _context5.t0);
        case 11:
        case "end":
  ...
  return function showRecipesSendSPSLogTable_cs() {
    return _ref5.apply(this, arguments);
  };
}();
var showMyRecipeSendTable_de = exports.showMyRecipeSendTable_de = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(apiUrl, "/recipeSendSPSLog/").concat(userID)
          });
        case 4:
          res = _context6.sent;
          if (res.data.status === 'success') {
            ...
            table = $('#myRecipeSendTable_de').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
        ...
        case 8:
          ...
          console.error('Fehler in showMyRecipeSendTable_de:', _context6.t0);
        case 11:
        case "end":
  ...
  return function showMyRecipeSendTable_de(_x7) {
    return _ref6.apply(this, arguments);
  };
}();
var showMyRecipeSendTable_cs = exports.showMyRecipeSendTable_cs = /*#__PURE__*/function () {
      ...
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            table = $('#myRecipeSendTable_cs').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
        ...
        case 8:
          ...
          console.error('Fehler in showMyRecipeSendTable_cs:', _context7.t0);
        case 11:
        case "end":
  ...
  return function showMyRecipeSendTable_cs(_x8) {
    return _ref7.apply(this, arguments);
  };
}();
var showMyRecipeSendTable = exports.showMyRecipeSendTable = /*#__PURE__*/function () {
      ...
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            table = $('#myRecipeSendTable').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
        ...
        case 8:
          ...
          console.error('Fehler in showMyRecipeSendTable:', _context8.t0);
        case 11:
        case "end":
  ...
  return function showMyRecipeSendTable(_x9) {
    return _ref8.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"recipeStatistic.js":[function(require,module,exports) {
var define;
...
exports.showRecipeStatisticTable_de = exports.showRecipeStatisticTable_cs = exports.showRecipeStatisticTable = exports.createRecipeStatistic_noInlogt = exports.createRecipeStatistic = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var createRecipeStatistic = exports.createRecipeStatistic = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(recipeSendSPSLogID, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('bin createRecipeStatistic zum serverschicken und habe bekommen: ', recipeSendSPSLogID, userSendData, fa_Nummer);
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipeStatistic/createRecipeStatistic"),
            data: {
        ...
        case 4:
          ...
          (0, _alerts.showAlert)('success', 'RecipeStatistic successfully created or updated');
          _context.next = 9;
          return new Promise(function (resolve) {
  ...
  return function createRecipeStatistic(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var createRecipeStatistic_noInlogt = exports.createRecipeStatistic_noInlogt = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(recipeSendSPSLogID, userSendData, fa_Nummer) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          console.log('bin createRecipeStatistic_noInlogt zum serverschicken und habe bekommen: ', recipeSendSPSLogID, userSendData, fa_Nummer);
          _context2.prev = 1;
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overview"));
            }, 1200);
          } else {
            console.log('Failed to create or update recipeStatistic!');
          }
  ...
  return function createRecipeStatistic_noInlogt(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
var showRecipeStatisticTable_de = exports.showRecipeStatisticTable_de = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var res, table;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(apiUrl, "/recipeStatistic")
          });
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            ...
            $.fn.dataTable.ext.type.order['date-de-pre'] = function (data) {
              ...
              var _data$split = data.split(' '),
                ...
                datePart = _data$split2[0],
                timePart = _data$split2[1];
            ...
            table = $('#recipeStatisticTable_de').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
              ...
              columns: [{
                ...
                title: 'Sendungen',
                data: 'sendData',
                // Referenz auf das gesamte Array
                width: '10%',
                render: function render(data) {
                  // Überprüfen, ob `sendData` ein Array ist
                  if (Array.isArray(data)) {
                    return data.map(function (item) {
                      return item.sendDate ? new Date(item.sendDate).toLocaleDateString('de-DE', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
              ...
              // },
              {
                ...
                render: function render(data) {
                  if (Array.isArray(data) && data.length > 0) {
                    return data.map(function (item) {
                      return "vFwd: ".concat(item.dVFwd || '-', "%, vBwd: ").concat(item.dVBwd || '-', "%");
                ...
                width: '34%',
                render: function render(data) {
                  return Array.isArray(data) ? data.join('<br>') : JSON.stringify(data) || '-';
                }
              }],
        ...
        case 8:
          _context3.prev = 8;
          _context3.t0 = _context3["catch"](1);
          console.error('Fehler in showRecipeStatisticTable_de:', _context3.t0);
        case 11:
        case "end":
          return _context3.stop();
      }
  ...
  return function showRecipeStatisticTable_de() {
    return _ref3.apply(this, arguments);
  };
}();
var showRecipeStatisticTable_cs = exports.showRecipeStatisticTable_cs = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var res, table;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
          ...
          if (res.data.status === 'success') {
            ...
            $.fn.dataTable.ext.type.order['date-de-pre'] = function (data) {
              var _data$split3 = data.split(' '),
                ...
                datePart = _data$split4[0],
                timePart = _data$split4[1];
              ...
              var _parts2 = _slicedToArray(parts, 3),
                ...
                year = _parts2[2];
              if (timePart) {
                var _timePart$split$map3 = timePart.split(':').map(Number),
                  _timePart$split$map4 = _slicedToArray(_timePart$split$map3, 2),
                  hours = _timePart$split$map4[0],
                  minutes = _timePart$split$map4[1];
                return new Date(year, month - 1, day, hours || 0, minutes || 0).getTime();
              }
              return new Date(year, month - 1, day).getTime();
            };
            table = $('#recipeStatisticTable_cs').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
        ...
        case 8:
          _context4.prev = 8;
          _context4.t0 = _context4["catch"](1);
          console.error('Fehler in showRecipeStatisticTable_cs:', _context4.t0);
        case 11:
        case "end":
          return _context4.stop();
      }
  ...
  return function showRecipeStatisticTable_cs() {
    return _ref4.apply(this, arguments);
  };
}();
var showRecipeStatisticTable = exports.showRecipeStatisticTable = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var res, table;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
          ...
          if (res.data.status === 'success') {
            ...
            $.fn.dataTable.ext.type.order['date-de-pre'] = function (data) {
              ...
              var _data$split5 = data.split(' '),
                ...
                datePart = _data$split6[0],
                timePart = _data$split6[1];
              if (!datePart) return 0; // Wenn kein gültiges Datum vorliegt

              var parts = datePart.split('.');
              if (parts.length !== 3) return 0;
              var _parts3 = _slicedToArray(parts, 3),
                day = _parts3[0],
                month = _parts3[1],
                year = _parts3[2];
              ...
              // Falls eine Zeitangabe existiert, diese auch berücksichtigen
              if (timePart) {
                var _timePart$split$map5 = timePart.split(':').map(Number),
                  _timePart$split$map6 = _slicedToArray(_timePart$split$map5, 2),
                  hours = _timePart$split$map6[0],
                  minutes = _timePart$split$map6[1];
                return new Date(year, month - 1, day, hours || 0, minutes || 0).getTime();
              }
            ...
            table = $('#recipeStatisticTable').DataTable({
              data: res.data.data,
              dom: 'l<"toolbar">frtip',
              pagingType: 'full_numbers',
              paging: true,
        ...
        case 8:
          _context5.prev = 8;
          _context5.t0 = _context5["catch"](1);
          console.error('Fehler in showRecipeStatisticTable:', _context5.t0);
        case 11:
        case "end":
          return _context5.stop();
      }
  ...
  return function showRecipeStatisticTable() {
    return _ref5.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"recipes.js":[function(require,module,exports) {
var define;
...
exports.updateRecipe = exports.showRecipesTDToverviewTable_de_NotInlogt = exports.showRecipesTDToverviewTable_de = exports.showRecipesTDToverviewTable_cs_NotInlogt = exports.showRecipesTDToverviewTable_cs = exports.showRecipesTDToverviewTable = exports.saveWriteAllRecipteToTXT_Files = exports.deleteRecipe = exports.default = exports.createRecipe_ExpertJCD = exports.createRecipe3_St_4_MBSBM = exports.createRecipe3_St_4_BMSMB = exports.createRecipe2_St_6_BSBSBSB = exports.createRecipe2_St_4_SBSBS = exports.createRecipe2_St_2_BSB = exports.convertOldRecipes = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* elint-disable */
var dev_Port = 8555;
var prod_Port = 8557;
var port = "development" === 'development' ? dev_Port : prod_Port;
var host = 'http://127.0.0.1:';
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var saveWriteAllRecipteToTXT_Files = exports.saveWriteAllRecipteToTXT_Files = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/saveAllRecipesToTXT")
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'All Recipe write successfully to TXT-files');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function saveWriteAllRecipteToTXT_Files() {
    return _ref.apply(this, arguments);
  };
}();
function loadLastSelectedRecipe() {
  var savedRecipe = localStorage.getItem('selectedRecipe');
  if (savedRecipe) {
    var rowDataNormal = JSON.parse(savedRecipe);
    var dynamicContentNormal = generateDynamicContent(rowDataNormal);
    $('#rightDiv').html(dynamicContentNormal);
    var canvasNormal = document.getElementById('eckenCanvas');
    if (canvasNormal) {
      var ctxNormal = canvasNormal.getContext('2d');
      var eckenListeNormal = rowDataNormal.eckenListe;
      var paddingNormal = 120; //200; //120;
      var minXNormal = Math.min.apply(Math, _toConsumableArray(eckenListeNormal.ecke.map(function (ecke) {
        return ecke.x;
      })));
      ...
      var minZXXXNormal = Math.min.apply(Math, _toConsumableArray(eckenListeNormal.ecke.map(function (ecke) {
        return ecke.z;
      })));
      var minYNormal = Math.max(minZXXXNormal - 0.5, Math.min.apply(Math, [0].concat(_toConsumableArray(eckenListeNormal.ecke.map(function (ecke) {
        return ecke.z;
      })))));
      var scaleXNormal = (ctxNormal.canvas.width - 2 * paddingNormal) / (Math.max.apply(Math, _toConsumableArray(eckenListeNormal.ecke.map(function (ecke) {
        return ecke.x;
      }))) - minXNormal);
      var scaleYNormal = (ctxNormal.canvas.height - 2 * paddingNormal) / (Math.max.apply(Math, _toConsumableArray(eckenListeNormal.ecke.map(function (ecke) {
        return ecke.z;
      }))) - minYNormal);
      drawYAxis(ctxNormal, eckenListeNormal, paddingNormal, scaleXNormal, minYNormal, scaleYNormal);
      drawXAxis(ctxNormal, eckenListeNormal, rowDataNormal.standartWerte, paddingNormal, scaleYNormal, minXNormal, minYNormal);
      drawGrid(ctxNormal, eckenListeNormal, scaleXNormal, scaleYNormal, paddingNormal, minXNormal, minYNormal);
      drawEckenListe(ctxNormal, eckenListeNormal, scaleXNormal, scaleYNormal, paddingNormal, minXNormal, minYNormal);
      if (rowDataNormal.standartWerte) {
        drawUpperToleranceLine(ctxNormal, eckenListeNormal, rowDataNormal.standartWerte, scaleXNormal, scaleYNormal, paddingNormal, minXNormal, minYNormal);
        drawLowerToleranceLine(ctxNormal, eckenListeNormal, rowDataNormal.standartWerte, scaleXNormal, scaleYNormal, paddingNormal, minXNormal, minYNormal);
      }
    }
  }
}
var updateRecipe = exports.updateRecipe = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data, recipeID) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/updateRecipe/").concat(recipeID),
            data: {
        ...
        case 5:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe updated successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function updateRecipe(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();
var deleteRecipe = exports.deleteRecipe = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(recipeID) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "".concat(apiUrl, "/recipes/deleteRecipe/").concat(recipeID)
          });
        case 4:
          res = _context3.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Recipe successfully deleted');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 500);
          }
  ...
  return function deleteRecipe(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
var createRecipe3_St_4_BMSMB = exports.createRecipe3_St_4_BMSMB = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe3_St_4_BMSMB"),
            data: {
              recipeData: data
            }
          });
        case 6:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe3_St_4_BMSMB created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe3_St_4_BMSMB(_x4) {
    return _ref4.apply(this, arguments);
  };
}();
var createRecipe3_St_4_MBSBM = exports.createRecipe3_St_4_MBSBM = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe3_St_4_MBSBM"),
            data: {
              recipeData: data
            }
          });
        case 6:
          res = _context5.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe3_St_4_MBSBM created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe3_St_4_MBSBM(_x5) {
    return _ref5.apply(this, arguments);
  };
}();
var createRecipe_ExpertJCD = exports.createRecipe_ExpertJCD = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe_ExpertJCD"),
            data: {
              recipeData: data
            }
          });
        case 6:
          res = _context6.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe_ExpertJCD created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe_ExpertJCD(_x6) {
    return _ref6.apply(this, arguments);
  };
}();
var createRecipe2_St_6_BSBSBSB = exports.createRecipe2_St_6_BSBSBSB = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe2_St_6_BSBSBSB"),
            data: {
              recipeData: data
            }
          });
        case 6:
          res = _context7.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe2_St_6_BSBSBSB created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe2_St_6_BSBSBSB(_x7) {
    return _ref7.apply(this, arguments);
  };
}();
var createRecipe2_St_4_SBSBS = exports.createRecipe2_St_4_SBSBS = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe2_St_4_SBSBS"),
            data: {
              recipeData: data
            }
          });
        case 6:
          res = _context8.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe2_St_4_SBSBS created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe2_St_4_SBSBS(_x8) {
    return _ref8.apply(this, arguments);
  };
}();
var createRecipe2_St_2_BSB = exports.createRecipe2_St_2_BSB = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/createRecipe2_St_2_BSB"),
            data: {
              recipeData: data
            }
          });
        case 6:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Recipe2_St_2_BSB created successfully');
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/overviewInlogt"));
            }, 1200);
          } else {
  ...
  return function createRecipe2_St_2_BSB(_x9) {
    return _ref9.apply(this, arguments);
  };
}();
var convertOldRecipes = exports.convertOldRecipes = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(importOldRecipes) {
    var res;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/recipes/convertOldRecipesToMongoDB"),
            data: {
        ...
        case 5:
          res = _context10.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Old-Recipes confert to mongoDB successfully');
            window.setTimeout(function () {
              location.assign("".concat(apiUrl, "/overviewInlogt"));
            }, 1200);
          } else {
        ...
        case 9:
          ...
          window.setTimeout(function () {
            location.assign("".concat(apiUrl, "/txt_xml_fileuploader"));
          }, 3200);
        case 14:
        case "end":
  ...
  return function convertOldRecipes(_x10) {
    return _ref10.apply(this, arguments);
  };
}();
var showRecipesTDToverviewTable_de_NotInlogt = exports.showRecipesTDToverviewTable_de_NotInlogt = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    var res, recipesArrayNormal, dataTableNormal;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(apiUrl, "/recipes/recipesTDTtoLoad")
          });
        case 4:
          res = _context11.sent;
          ...
          if (res.data && res.data.status === 'success') {
            ...
            $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
              ...
              var artikelName = data[2] || ''; // Index 2 für die Artikelname-Spalte
              var selectedSpeed = $('#speedFilter').val(); // Aktueller Wert des Dropdowns
            ...
            recipesArrayNormal = res.data.data.recipesTDTtoLoad.map(function (recipe) {
              return {
                id: recipe._id,
                ...
                lastCommentDate: recipe.kopfDaten.kommentar.length > 0 ? new Date(recipe.kopfDaten.kommentar[recipe.kopfDaten.kommentar.length - 1].erstelltAm).toLocaleDateString('de-DE', {
                  day: '2-digit',
                  month: '2-digit',
                  year: 'numeric'
                }) : '',
                lastCommentUser: recipe.kopfDaten.kommentar.length > 0 ? recipe.kopfDaten.kommentar[recipe.kopfDaten.kommentar.length - 1].createdBy.firstName : '',
                mindestGutanteil: recipe.rohrWerte.mindestGutanteil,
                profileGekoppelt: recipe.rohrWerte.profileGekoppelt,
                rohrAussenDurchmesserLetzterZug: recipe.dornWerte.rohrAussenDurchmesserLetzterZug,
                rohrInnenDurchmesserLetzterZug: recipe.dornWerte.rohrInnenDurchmesserLetzterZug,
                angel: recipe.dornWerte.angel,
                rohrAussenDurchmesserTDTZug: recipe.dornWerte.rohrAussenDurchmesserTDTZug,
            ...
            dataTableNormal = $('#recipesTDToverviewTable_de_NotInlogt').DataTable({
              pagingType: 'full_numbers',
              paging: true,
              scrollX: false,
              scrollY: 500,
              language: {
                lengthMenu: 'Display _MENU_ Rezepte pro Seite',
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable_de_NotInlogt tbody').on('click', 'tr', function () {
                var rowDataNormal = dataTableNormal.row(this).data();
                ...
                $('#recipesTDToverviewTable_de_NotInlogt tbody tr').removeClass('highlightTableClick');
        ...
        case 9:
          ...
          console.error('Error in showRecipesTDToverviewTable_de_NotInlogt:', _context11.t0);
  ...
  return function showRecipesTDToverviewTable_de_NotInlogt() {
    return _ref11.apply(this, arguments);
  };
}();
var showRecipesTDToverviewTable_cs_NotInlogt = exports.showRecipesTDToverviewTable_cs_NotInlogt = /*#__PURE__*/function () {
      ...
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 4:
          ...
          if (res.data && res.data.status === 'success') {
            ...
            dataTableNormal = $('#recipesTDToverviewTable_cs_NotInlogt').DataTable({
              pagingType: 'full_numbers',
              paging: true,
              scrollX: false,
              scrollY: 500,
              language: {
                lengthMenu: 'Display _MENU_ Recepty na stránce',
                //'Display _MENU_ records per page',
                zeroRecords: 'Nothing found - sorry',
                info: 'Zobrazit _START_ bis _END_ von _TOTAL_ recepty',
                //'Showing page _PAGE_ of _PAGES_',
                infoEmpty: 'No records available',
                infoFiltered: '(filtered from _MAX_ total records)',
                //'(filtered from _MAX_ total records)',
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable_cs_NotInlogt tbody').on('click', 'tr', function () {
                var rowDataNormal = dataTableNormal.row(this).data();
                console.log('rowData bei Klick in Tabelle angewählt:', rowDataNormal);
                console.log('rowData.kommentar:', rowDataNormal.kommentar);
                localStorage.setItem('selectedRecipe', JSON.stringify(rowDataNormal));
                var eckenListeNormal = rowDataNormal.eckenListe;
                var dynamicContentNormal = generateDynamicContent_cs(rowDataNormal);
                $('#rightDiv').html(dynamicContentNormal);
                $('#recipeToSendRowdataInput').val(JSON.stringify(rowDataNormal));
                localStorage.setItem('selectedRecipe', JSON.stringify(rowDataNormal));
                // Canvas für die Eckenliste zeichnen
                ...
                $('#recipesTDToverviewTable_cs_NotInlogt tbody tr').removeClass('highlightTableClick');
                $(this).addClass('highlightTableClick');
              });
            });
            loadLastSelectedRecipe();
        ...
        case 9:
          ...
          console.error('Error in showRecipesTDToverviewTable_cs_NotInlogt:', _context12.t0);
          (0, _alerts.showAlert)('error', err.response.data.message);
        case 13:
        case "end":
  ...
  return function showRecipesTDToverviewTable_cs_NotInlogt() {
    return _ref12.apply(this, arguments);
  };
}();
var showRecipesTDToverviewTable_de = exports.showRecipesTDToverviewTable_de = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(user) {
    var res, userInlogt, userRole, recipesArrayNormal, dataTableNormal;
      ...
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 4:
          ...
          if (res.data && res.data.status === 'success') {
            ...
            userInlogt = JSON.parse(res.data.data.userInlogt);
            userRole = userInlogt.role;
            ...
            dataTableNormal = $('#recipesTDToverviewTable_de').DataTable({
              pagingType: 'full_numbers',
              paging: true,
              scrollX: false,
              scrollY: 450,
              language: {
                search: 'Suche:',
                lengthMenu: 'Zeige: _MENU_ Rezepte pro Seite',
                //'Display _MENU_ records per page',
                zeroRecords: 'Nothing found - sorry',
                info: 'Zeige _START_ bis _END_ von _TOTAL_ Rezepten',
                //'Showing page _PAGE_ of _PAGES_',
                infoEmpty: 'No records available',
                infoFiltered: '(Gefiltert _MAX_ von totalen Rezepten)',
                //'(filtered from _MAX_ total records)',
                paginate: {
                  first: 'Erste',
                  last: 'Letzte',
              ...
              columns: [{
                ...
                render: function render(data) {
                  ...
                  return "\n                <a href=\"".concat(apiUrl, "/recipes/updateRecipe/").concat(data, "\" class=\"edit-button\">\n                  <svg class=\"heading-box__icon\">\n                  <use xlink:href=\"/img/icons.svg#icon-edit-3\"></use>\n                  </svg>\n                </a>");
                },
                orderable: false
              }],
              data: recipesArrayNormal
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable_de tbody').on('click', 'tr', function () {
                ...
                $('#recipesTDToverviewTable_de tbody tr').removeClass('highlightTableClick');
                $(this).addClass('highlightTableClick');
        ...
        case 11:
          ...
          console.error('Error in showRecipesTDToverviewTable_de:', _context13.t0);
          (0, _alerts.showAlert)('error', err.response.data.message);
        case 15:
        case "end":
  ...
  return function showRecipesTDToverviewTable_de(_x11) {
    return _ref13.apply(this, arguments);
  };
}();
var showRecipesTDToverviewTable_cs = exports.showRecipesTDToverviewTable_cs = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(user) {
    var res, userInlogt, userRole, recipesArrayNormal, dataTableNormal;
      ...
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 4:
          ...
          if (res.data && res.data.status === 'success') {
            ...
            $.fn.dataTable.ext.type.order['date-de-pre'] = function (data) {
              // Parse dd.mm.yyyy hh:mm to Date
              var _data$split7 = data.split(' '),
                _data$split8 = _slicedToArray(_data$split7, 2),
                datePart = _data$split8[0],
                timePart = _data$split8[1];
              if (!datePart) return 0; // Wenn kein gültiges Datum vorliegt

              var parts = datePart.split('.');
              if (parts.length !== 3) return 0;
              var _parts4 = _slicedToArray(parts, 3),
                day = _parts4[0],
                month = _parts4[1],
                year = _parts4[2];
              ...
              // Falls eine Zeitangabe existiert, diese auch berücksichtigen
              if (timePart) {
                var _timePart$split$map7 = timePart.split(':').map(Number),
                  _timePart$split$map8 = _slicedToArray(_timePart$split$map7, 2),
                  hours = _timePart$split$map8[0],
                  minutes = _timePart$split$map8[1];
                return new Date(year, month - 1, day, hours || 0, minutes || 0).getTime();
              }
            ...
            dataTableNormal = $('#recipesTDToverviewTable_cs').DataTable({
              pagingType: 'full_numbers',
              paging: true,
              scrollX: false,
              scrollY: 450,
              language: {
                search: 'Hledat:',
                lengthMenu: 'Zobrazit _MENU_ Recepty na stránce',
                //'Display _MENU_ records per page',
                zeroRecords: 'Nothing found - sorry',
                info: 'Zobrazit _START_ do _END_ od _TOTAL_ recepty',
                //'Showing page _PAGE_ of _PAGES_',
                infoEmpty: 'Žádné záznamy nejsou k dispozici.',
                infoFiltered: '(filtrováno z _MAX_ total recepty)',
                //'(filtered from _MAX_ total records)',
                paginate: {
                  first: 'První',
                  last: 'Poslední',
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable_cs tbody').on('click', 'tr', function () {
                ...
                // Hervorhebung der angeklickten Zeile
                $('#recipesTDToverviewTable_cs tbody tr').removeClass('highlightTableClick');
                $(this).addClass('highlightTableClick');
        ...
        case 9:
          ...
          console.error('Error in showRecipesTDToverviewTable_cs:', _context14.t0);
          (0, _alerts.showAlert)('error', err.response.data.message);
        case 13:
        case "end":
  ...
  return function showRecipesTDToverviewTable_cs(_x12) {
    return _ref14.apply(this, arguments);
  };
}();
var showRecipesTDToverviewTable = exports.showRecipesTDToverviewTable = /*#__PURE__*/function () {
  var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(user) {
    var res, userInlogt, userRole, recipesArray, dataTable;
      ...
      while (1) switch (_context15.prev = _context15.next) {
        ...
        case 4:
          ...
          if (res.data && res.data.status === 'success') {
            ...
            userRole = userInlogt.role;
            console.log('userRole:', userRole);
            recipesArray = res.data.data.recipesTDTtoLoad.map(function (recipe) {
              return {
                id: recipe._id,
                artikelNummer: recipe.kopfDaten.artikelNummer,
                artikelName: recipe.kopfDaten.artikelName,
                ...
                lastCommentUser: recipe.kopfDaten.kommentar.length > 0 ? recipe.kopfDaten.kommentar[recipe.kopfDaten.kommentar.length - 1].createdBy.firstName : 'eeee',
                mindestGutanteil: recipe.rohrWerte.mindestGutanteil,
                profileGekoppelt: recipe.rohrWerte.profileGekoppelt,
                rohrAussenDurchmesserLetzterZug: recipe.dornWerte.rohrAussenDurchmesserLetzterZug,
                rohrInnenDurchmesserLetzterZug: recipe.dornWerte.rohrInnenDurchmesserLetzterZug,
            ...
            $.fn.dataTable.ext.type.order['date-de-pre'] = function (data) {
              // Parse dd.mm.yyyy hh:mm to Date
              var _data$split9 = data.split(' '),
                _data$split10 = _slicedToArray(_data$split9, 2),
                datePart = _data$split10[0],
                timePart = _data$split10[1];
              if (!datePart) return 0; // Wenn kein gültiges Datum vorliegt

              var parts = datePart.split('.');
              if (parts.length !== 3) return 0;
              var _parts5 = _slicedToArray(parts, 3),
                day = _parts5[0],
                month = _parts5[1],
                year = _parts5[2];
              ...
              // Falls eine Zeitangabe existiert, diese auch berücksichtigen
              if (timePart) {
                var _timePart$split$map9 = timePart.split(':').map(Number),
                  _timePart$split$map10 = _slicedToArray(_timePart$split$map9, 2),
                  hours = _timePart$split$map10[0],
                  minutes = _timePart$split$map10[1];
                return new Date(year, month - 1, day, hours || 0, minutes || 0).getTime();
              }
            ...
            dataTable = $('#recipesTDToverviewTable').DataTable({
              pagingType: 'full_numbers',
              paging: true,
              scrollX: false,
              scrollY: 450,
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable tbody').on('click', 'tr', function () {
                ...
                var eckenListe = rowData.eckenListe;
                var dynamicContent = generateDynamicContent_en(rowData);
                $('#rightDiv').html(dynamicContent);
                $('#recipeToSendRowdataInput').val(JSON.stringify(rowData));

                // Canvas für die Eckenliste zeichnen
                var canvas = document.getElementById('eckenCanvas');
                if (!canvas) {
                  console.error('Canvas-Element nicht gefunden');
                  return;
                }
                ...
                var padding = 120; //120;
                var minZXXX = Math.min.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
                  return ecke.z;
                })));
                ...
                // );
                var minX = Math.min.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
                  return ecke.x;
                })));
                //const minY = Math.min(...eckenListe.ecke.map((ecke) => ecke.z));
                var minY = Math.max(minZXXX - 0.5, Math.min.apply(Math, [0].concat(_toConsumableArray(eckenListe.ecke.map(function (ecke) {
                  return ecke.z;
                })))));
                //const minY = Math.min(0, ...eckenListe.ecke.map((ecke) => ecke.z));
                var scaleX = (ctx.canvas.width - 2 * padding) / (Math.max.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
                  return ecke.x;
                }))) - minX);
                var scaleY = (ctx.canvas.height - 2 * padding) / (Math.max.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
                  return ecke.z;
                }))) - minY);
                ...
                drawXAxis(ctx, eckenListe, rowData.standartWerte, padding, scaleY, minX, minY);
                ...
                if (rowData.standartWerte) {
                  drawUpperToleranceLine(ctx, eckenListe, rowData.standartWerte, scaleX, scaleY, padding, minX, minY);
                  drawLowerToleranceLine(ctx, eckenListe, rowData.standartWerte, scaleX, scaleY, padding, minX, minY);
                }
                $('#recipesTDToverviewTable tbody tr').removeClass('highlightTableClick');
                $(this).addClass('highlightTableClick');
              });
            });
            loadLastSelectedRecipe();
        ...
        case 9:
          ...
          console.error('Error in showRecipesTDToverviewTable:', _context15.t0);
          (0, _alerts.showAlert)('error', err.response.data.message);
        case 13:
        case "end":
  ...
  return function showRecipesTDToverviewTable(_x13) {
    return _ref15.apply(this, arguments);
  };
}();
function drawXAxis(ctx, eckenListe, standartWerte, padding, scaleY, minX, minY) {
  var xAxisY = ctx.canvas.height - padding - (0 - minY) * scaleY;
  ...
  var maxX = Math.max.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
    return ecke.x;
  })));
  var scaleX = (ctx.canvas.width - 2 * padding) / (maxX - minX);
  var yPos = ctx.canvas.height - padding + 0.2 / scaleY + 0;
  ...
  for (var x = minX; x <= maxX; x += 250) {
    var xPos = padding + (x - minX) * scaleX;
    console.log('xPos: ' + xPos);
    ctx.fillText(x.toString(), xPos, yPos + 20);
  }
  var yPosXXX = ctx.canvas.height - padding + 0.2 / scaleY + 0; // gleiche yPos wie in vorherigen Funktion

  for (var i = 0; i <= ctx.canvas.width - 2 * padding; i++) {
    ctx.beginPath();
...
function drawYAxis(ctx, eckenListe, padding, scaleX, minY, scaleY) {
  ...
  var yAxisX = padding + (0 - minY) * scaleX; //pposition 0 bei x-achse-0
  ...
  ctx.fillStyle = 'black';
  ctx.textAlign = 'right';
  var maxY = Math.max.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
    return ecke.z;
  })));
  var minZ = Math.min.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
    return ecke.z;
  }))) - 0.5;
  var step = 0.1;
  for (var y = minZ; y <= maxY + 0.5; y += step) {
    //Schrift-bezeichnung
    //minZ - 0.2
    //const yPos = ctx.canvas.height - padding - (y - minY) * scaleY;
    var yPos = ctx.canvas.height - padding - (y - minY) * scaleY; // text unterhalb zahlen
...
function drawScaleX(ctx, eckenListe, standartWerte) {
  ...
  var minY = Math.min.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
    return ecke.z - standartWerte.untereToleranz;
  }) + 2));
  var maxY = Math.max.apply(Math, _toConsumableArray(eckenListe.ecke.map(function (ecke) {
    return ecke.z + standartWerte.obereToleranz;
  }) + 2));

  // Skalierungsfaktor für die y-Höhe berechnen
  var scaleY = (ctx.canvas.height - 2 * padding) / (maxY - minY);
...
function drawGrid(ctx, eckenListe, scaleX, scaleY, padding, minX, minY) {
  ...
  eckenListe.ecke.forEach(function (ecke) {
    var x = padding + (ecke.x - minX) * scaleX;
  ...
  eckenListe.ecke.forEach(function (ecke) {
    var y = ctx.canvas.height - padding - (ecke.z - minY) * scaleY;
...
function drawEckenListe(ctx, eckenListe, scaleX, scaleY, padding, minX, minY) {
  // Eckenliste zeichnen
  ctx.beginPath();
  ctx.moveTo(padding + (eckenListe.ecke[0].x - minX) * scaleX, ctx.canvas.height - padding - (eckenListe.ecke[0].z - minY) * scaleY);
  var _iterator = _createForOfIteratorHelper(eckenListe.ecke),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var ecke = _step.value;
      ctx.lineTo(padding + (ecke.x - minX) * scaleX, ctx.canvas.height - padding - (ecke.z - minY) * scaleY);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function drawUpperToleranceLine(ctx, eckenListe, standartWerte, scaleX, scaleY, padding, minX, minY) {
  var upperToleranceEckenListe = eckenListe.ecke.map(function (e) {
    return {
      x: e.x,
      z: e.z + standartWerte.obereToleranz
    };
  });
  ctx.beginPath();
  ...
  ctx.moveTo(padding + (upperToleranceEckenListe[0].x - minX) * scaleX, ctx.canvas.height - padding - (upperToleranceEckenListe[0].z - minY) * scaleY);
  var _iterator2 = _createForOfIteratorHelper(upperToleranceEckenListe),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var ecke = _step2.value;
      ctx.lineTo(padding + (ecke.x - minX) * scaleX, ctx.canvas.height - padding - (ecke.z - minY) * scaleY);
    }
  } catch (err) {
    _iterator2.e(err);
...
function drawLowerToleranceLine(ctx, eckenListe, standartWerte, scaleX, scaleY, padding, minX, minY) {
  var lowerToleranceEckenListe = eckenListe.ecke.map(function (e) {
    return {
      x: e.x,
      z: e.z - standartWerte.untereToleranz
    };
  });
  ctx.beginPath();
  ...
  ctx.moveTo(padding + (lowerToleranceEckenListe[0].x - minX) * scaleX, ctx.canvas.height - padding - (lowerToleranceEckenListe[0].z - minY) * scaleY);
  var _iterator3 = _createForOfIteratorHelper(lowerToleranceEckenListe),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var ecke = _step3.value;
      ctx.lineTo(padding + (ecke.x - minX) * scaleX, ctx.canvas.height - padding - (ecke.z - minY) * scaleY);
    }
  } catch (err) {
    _iterator3.e(err);
...
function generateDynamicContent(rowData) {
  var canvasWidth = 900; //550;
  var canvasHeight = 500; //550; //550; //800; //550;
  var maxX = 2000;
  var maxZ = 8;
  var tolerance = 2;
  return "\n\n    <h1 style=\"margin-left:25px;\">".concat(rowData.artikelNummer, "</h1>\n    <h1 style=\"margin-left:25px;\">").concat(rowData.artikelName, "</h1>\n\n    <div id=\"eckenCanvasContainer\" style=\"width: ").concat(canvasWidth, "px; height: 450px; border: 2px solid transparent; position: relative; overflow: hidden;\">\n      <canvas id=\"eckenCanvas\" style=\"position: absolute;  border: 5px solid transparent; padding-top: 10px; margin-left: -75px; margin-top: 1px;\" width=\"").concat(canvasWidth, "\" height=\"").concat(canvasHeight, "\"></canvas>\n    </div>\n\n    <!-- <p></p> -->\n    <!-- <p></p> -->\n    <!-- <p style=\"color: black;\">Artikelnummer: ").concat(rowData.artikelNummer, "</p> -->\n    <!-- <p style=\"color: black;\">ArtikelName: ").concat(rowData.artikelName, "</p> -->\n    <!-- <p>Kommentar: ").concat(rowData.kommentar, "</p> -->\n    <!-- <p>Dornstufen: ").concat(JSON.stringify(rowData.dornstufen), "</p> -->\n    <!-- <p>Eckenliste: ").concat(JSON.stringify(rowData.eckenListe), "</p> -->\n    <!-- <p>StandartWerte: ").concat(JSON.stringify(rowData.standartWerte), "</p> -->\n    <!-- <p></p> -->\n    <h2 style=\"color: black; margin-left:25px;\">Zieh-Geschwindigkeit: ").concat(rowData.ziehGeschwindigkeit, "m/min &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  V-Dorn-Vor: ").concat(JSON.stringify(rowData.v_dorn_Fwd), "% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   V-Dorn-Zur\xFCck: ").concat(JSON.stringify(rowData.v_dorn_Bwd), "%</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Profile gekoppelt: ").concat(JSON.stringify(rowData.rohrWerte.profileGekoppelt), "</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Ausgleichst\xFCck: ").concat(JSON.stringify(rowData.mehrfachlaengenDaten.ausgleichstueck), "</h2>\n    <!-- <br></br>  -->\n    <!-- <p></p> -->\n  ");
}
function generateDynamicContent_cs(rowData) {
  ...
  var maxZ = 8;
  var tolerance = 2;
  return "\n\n    <h1 style=\"margin-left:25px;\">".concat(rowData.artikelNummer, "</h1>\n    <h1 style=\"margin-left:25px;\">").concat(rowData.artikelName, "</h1>\n\n    <div id=\"eckenCanvasContainer\" style=\"width: ").concat(canvasWidth, "px; height: 450px; border: 2px solid transparent; position: relative; overflow: hidden;\">\n      <canvas id=\"eckenCanvas\" style=\"position: absolute;  border: 5px solid transparent; padding-top: 10px; margin-left: -75px; margin-top: 1px;\" width=\"").concat(canvasWidth, "\" height=\"").concat(canvasHeight, "\"></canvas>\n    </div>\n\n    <!-- <p></p> -->\n    <!-- <p></p> -->\n    <!-- <p style=\"color: black;\">Artikelnummer: ").concat(rowData.artikelNummer, "</p> -->\n    <!-- <p style=\"color: black;\">ArtikelName: ").concat(rowData.artikelName, "</p> -->\n    <!-- <p>Kommentar: ").concat(rowData.kommentar, "</p> -->\n    <!-- <p>Dornstufen: ").concat(JSON.stringify(rowData.dornstufen), "</p> -->\n    <!-- <p>Eckenliste: ").concat(JSON.stringify(rowData.eckenListe), "</p> -->\n    <!-- <p>StandartWerte: ").concat(JSON.stringify(rowData.standartWerte), "</p> -->\n    <!-- <p></p> -->\n    <h2 style=\"color: black; margin-left:25px;\">Rychlost ta\u017Een\xED: ").concat(rowData.ziehGeschwindigkeit, "m/min &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Rychlost trnu vp\u0159ed: ").concat(JSON.stringify(rowData.v_dorn_Fwd), "% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Rychlost trnu zp\u011Bt: ").concat(JSON.stringify(rowData.v_dorn_Bwd), "%</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Profily spojen\xE9: ").concat(JSON.stringify(rowData.rohrWerte.profileGekoppelt), "</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Kompens\xE1tor / Mezikus: ").concat(JSON.stringify(rowData.mehrfachlaengenDaten.ausgleichstueck), "</h2>\n    <!-- <br></br>  -->\n    <!-- <p></p> -->\n  ");
}
function generateDynamicContent_en(rowData) {
  var canvasWidth = 900; //550;
  var canvasHeight = 500; //550; //800; //550;
  var maxX = 2000;
  var maxZ = 8;
  var tolerance = 2;
  return "\n\n    <h1 style=\"margin-left:25px;\">".concat(rowData.artikelNummer, "</h1>\n    <h1 style=\"margin-left:25px;\">").concat(rowData.artikelName, "</h1>\n\n    <div id=\"eckenCanvasContainer\" style=\"width: ").concat(canvasWidth, "px; height: 450px; border: 2px solid transparent; position: relative; overflow: hidden;\">\n      <canvas id=\"eckenCanvas\" style=\"position: absolute;  border: 5px solid transparent; padding-top: 10px; margin-left: -75px; margin-top: 1px;\" width=\"").concat(canvasWidth, "\" height=\"").concat(canvasHeight, "\"></canvas>\n    </div>\n\n    <!-- <p></p> -->\n    <!-- <p></p> -->\n    <!-- <p style=\"color: black;\">Artikelnummer: ").concat(rowData.artikelNummer, "</p> -->\n    <!-- <p style=\"color: black;\">ArtikelName: ").concat(rowData.artikelName, "</p> -->\n    <!-- <p>Kommentar: ").concat(rowData.kommentar, "</p> -->\n    <!-- <p>Dornstufen: ").concat(JSON.stringify(rowData.dornstufen), "</p> -->\n    <!-- <p>Eckenliste: ").concat(JSON.stringify(rowData.eckenListe), "</p> -->\n    <!-- <p>StandartWerte: ").concat(JSON.stringify(rowData.standartWerte), "</p> -->\n    <!-- <p></p> -->\n    <!-- <h2 style=\"color: black; margin-left:25px;\">Drawing-speed: ").concat(JSON.stringify(rowData.ziehGeschwindigkeit), "</h2> -->\n    <h2 style=\"color: black; margin-left:25px;\">Drawing-speed: ").concat(rowData.ziehGeschwindigkeit, "m/min &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Thorn-speed forward: ").concat(JSON.stringify(rowData.v_dorn_Fwd), "% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Thorn-speed backward: ").concat(JSON.stringify(rowData.v_dorn_Bwd), "%</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Profile-coupled: ").concat(JSON.stringify(rowData.rohrWerte.profileGekoppelt), "</h2>\n    <h2 style=\"color: black; margin-left:25px;\">Compensation- piece: ").concat(JSON.stringify(rowData.mehrfachlaengenDaten.ausgleichstueck), "</h2>\n    <!-- <br></br> -->\n    <!-- <p></p> -->\n  ");
}
var _default = exports.default = convertOldRecipes;
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"user.js":[function(require,module,exports) {
var define;
...
exports.updateUser = exports.showUsers_de = exports.showUsers_cs = exports.showUsers = exports.deleteUser = exports.createNewUser = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var strPathApiV1 = '/api/v1';
var apiUrl = host + port + strPathApiV1;
var showUsers_de = exports.showUsers_de = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res, $employeeNumSortAscBtn, $employeeNumSortDescBtn, totalRecords;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (res.data.status === 'success') {
            ...
            $('#manageUsersTable_de').DataTable({
              ...
              columns: [{
                ...
                render: function render(data) {
                  console.log('Value of data:', data);
                  return "\n              <a href=\"".concat(apiUrl, "/manage_users/").concat(data, "\" class=\"edit-button\">\n                <svg class=\"heading-box__icon\">\n                <use xlink:href=\"/img/icons.svg#icon-edit-3\"></use>\n                </svg>\n              </a>");
                },
                orderable: false
              }]
            });
            $('#manageUsersTable_de').DataTable().order([1, 'asc']).draw();
            $employeeNumSortAscBtn = $('#manageUsersTable_de th.employee-number button-upDown.spam.arrow-up');
            $employeeNumSortDescBtn = $('#manageUsersTable_de th.employee-number button-upDown.spam.arrow-down');
            ...
            totalRecords = $('#manageUsersTable_de').DataTable().page.info().recordsTotal;
            $('#totalUsers').text("Total Users: ".concat(totalRecords));
          }
          _context.next = 11;
          break;
        case 8:
  ...
  return function showUsers_de() {
    return _ref.apply(this, arguments);
  };
}();
var showUsers_cs = exports.showUsers_cs = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res, $employeeNumSortAscBtn, $employeeNumSortDescBtn, totalRecords;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            $employeeNumSortAscBtn = $('#manageUsersTable_cs th.employee-number button-upDown.spam.arrow-up');
            $employeeNumSortDescBtn = $('#manageUsersTable_cs th.employee-number button-upDown.spam.arrow-down');
            $employeeNumSortAscBtn.on('click', function () {
              $('#manageUsersTable_cs').DataTable().order([1, 'asc']).draw();
            });
            $employeeNumSortDescBtn.on('click', function () {
            ...
            totalRecords = $('#manageUsersTable_cs').DataTable().page.info().recordsTotal;
            $('#totalUsers').text("Total Users: ".concat(totalRecords));
          }
          _context2.next = 11;
          break;
  ...
  return function showUsers_cs() {
    return _ref2.apply(this, arguments);
  };
}();
var showUsers = exports.showUsers = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var res, $employeeNumSortAscBtn, $employeeNumSortDescBtn, totalRecords;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            $employeeNumSortAscBtn = $('#manageUsersTable th.employee-number button-upDown.spam.arrow-up');
            $employeeNumSortDescBtn = $('#manageUsersTable th.employee-number button-upDown.spam.arrow-down');
            $employeeNumSortAscBtn.on('click', function () {
              $('#manageUsersTable').DataTable().order([1, 'asc']).draw();
            });
            $employeeNumSortDescBtn.on('click', function () {
            ...
            totalRecords = $('#manageUsersTable').DataTable().page.info().recordsTotal;
            $('#totalUsers').text("Total Users: ".concat(totalRecords));
          }
          _context3.next = 11;
          break;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/manage_users")); //
            }, 500);
          }
          _context4.next = 13;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "".concat(apiUrl, "/users/").concat(id)
          });
        case 4:
          res = _context5.sent;
          if (res.status === 204) {
...
var createNewUser = exports.createNewUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(employeeNumber, firstname, lastname, language, professional, email, password, passwordConfirm, role, department) {
    var res;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(apiUrl, "/users/createNewUser"),
            data: {
              employeeNumber: employeeNumber,
              firstName: firstname,
              lastName: lastname,
  ...
  return function createNewUser(_x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref6.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js","process":"../../node_modules/process/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setRecipeSendStatus = exports.recipeSendStatus = void 0;
...
var _recipeSendSPSLog = require("./recipeSendSPSLog");
var _recipeStatistic = require("./recipeStatistic");
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } /* eslint-disable */ // first line of imports, for older browsers
// DOM Element
...
var recipeSendForm = document.querySelector('.form--recipeSend');
var recipeSendForm_NotInlogt = document.querySelector('.form--recipeSend_NotInlogt');
var manageUsersTable = document.querySelector('.manageUsersTable');
var manageUsersTable_de = document.querySelector('.manageUsersTable_de');
var manageUsersTable_cs = document.querySelector('.manageUsersTable_cs');
var newUserDataForm = document.querySelector('.form-new-user-data');
var updateUserByAdminDataForm = document.querySelector('.form-workerAdmin-data');
var createRecipe2_St_2_BSB_DataForm = document.querySelector('.form-createRecipe-2_St_2_BSB-data');
var createRecipe2_St_4_SBSBS_DataForm = document.querySelector('.form-createRecipe-2_St_4_SBSBS-data');
var createRecipe2_St_6_BSBSBSB_DataForm = document.querySelector('.form-createRecipe-2_St_6_BSBSBSB-data');
var createRecipe3_St_4_MBSBM_DataForm = document.querySelector('.form-createRecipe-3_St_4_MBSBM-data');
var createRecipe3_St_4_BMSMB_DataForm = document.querySelector('.form-createRecipe-3_St_4_BMSMB-data');
var createRecipe_ExpertJCD_DataForm = document.querySelector('.form-createRecipe-ExpertJCD-data');
var updateRecipeDataForm = document.querySelector('.form-updateRecipe-data');
var dragDropForm = document.querySelector('.form--dragDrop');
var recipesTDToverviewTable = document.querySelector('.recipesTDToverviewTable');
var recipesTDToverviewTable_de_NotInlogt = document.querySelector('.recipesTDToverviewTable_de_NotInlogt');
var recipesTDToverviewTable_cs_NotInlogt = document.querySelector('.recipesTDToverviewTable_cs_NotInlogt');
var recipesTDToverviewTable_de = document.querySelector('.recipesTDToverviewTable_de');
var recipesTDToverviewTable_cs = document.querySelector('.recipesTDToverviewTable_cs');
var recipesSendSPSLogTable_de = document.querySelector('.recipesSendSPSLogTable_de');
var recipesSendSPSLogTable_cs = document.querySelector('.recipesSendSPSLogTable_cs');
var recipesSendSPSLogTable = document.querySelector('.recipesSendSPSLogTable');
var recipeStatisticTable_de = document.querySelector('.recipeStatisticTable_de');
var recipeStatisticTable_cs = document.querySelector('.recipeStatisticTable_cs');
var recipeStatisticTable = document.querySelector('.recipeStatisticTable');
var myRecipeSendTable_de = document.querySelector('.myRecipeSendTable_de');
var myRecipeSendTable_cs = document.querySelector('.myRecipeSendTable_cs');
var myRecipeSendTable = document.querySelector('.myRecipeSendTable');
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  (0, _login.login)(employeeNumber, password);
});
...
if (manageUsersTable_de) {
  ...
  (0, _user3.showUsers_de)();
}
if (manageUsersTable_cs) {
  console.log('bin if manageUsersTable_cs');
  (0, _user3.showUsers_cs)();
}
if (newUserDataForm) {
  newUserDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var employeeNumber, firstname, lastname, language, professional, email, password, passwordConfirm, role, selectedDepartments, department;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            ...
            selectedDepartments = Array.from(document.querySelectorAll('input[name="departments"]:checked')).map(function (department) {
            ...
            (0, _user3.createNewUser)(employeeNumber, firstname, lastname, language, professional, email, password, passwordConfirm, role, department);
          case 25:
          case "end":
            return _context2.stop();
        }
...
var saveUpdateUserByAdminButton = document.querySelector('.btn--saveUpdateUserByAdmin');
var deleteUpdateUserByAdminButton = document.querySelector('.btn--deleteUpdateUserByAdmin');
if (updateUserByAdminDataForm) {
  updateUserByAdminDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    var departmentString = document.querySelector('#department').value;
    console.log(id);
    console.log(employeeNumber);
    console.log(firstName);
    console.log(lastName);
    ...
    var departmentsArray = departmentString.split(',');
    console.log(departmentsArray);
    var department = departmentsArray;
    if (e.submitter === saveUpdateUserByAdminButton) {
      ...
      (0, _user3.deleteUser)(id);
    }
  });
}
var saveAllRecipteToTXT_FilesButton = document.querySelector('.btn--saveAllRecipteToTXT_Files');
if (saveAllRecipteToTXT_FilesButton) {
  ...
  saveAllRecipteToTXT_FilesButton.addEventListener('click', function (e) {
    ...
    (0, _recipes.saveWriteAllRecipteToTXT_Files)();
  });
}
var recipeSendButton = document.querySelector('.btn--recipeSend');
var recipeSendStatus = exports.recipeSendStatus = document.getElementById('recipeSendStatus');
var setRecipeSendStatus = exports.setRecipeSendStatus = function setRecipeSendStatus(message, isSuccess) {
  recipeSendStatus.textContent = message;
  recipeSendStatus.style.color = isSuccess ? 'green' : 'red';
};
if (recipeSendForm) {
  recipeSendButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var userSendData, fa_Nummer, recipeSendDataInput, recipeSendDataJSON, recipeSendData, sendDataA, recipeSendDataParse, spsResponse;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            console.log('Bin recipeSendForm');
            e.preventDefault();
            userSendData = document.getElementById('userSendData').value;
            console.log('userSendData: ' + userSendData);
            fa_Nummer = document.getElementById('fa_Nummer').value;
            console.log('fa_Nummer: ' + fa_Nummer);
            recipeSendDataInput = document.getElementById('recipeToSendRowdataInput');
            recipeSendDataJSON = '';
            recipeSendData = recipeSendDataInput.value;
            ...
            sendDataA = document.getElementById('sendDataA');
            if (!(recipeSendData.trim() !== '')) {
              _context3.next = 23;
              break;
            }
            console.log('Rezept am senden: ');
            recipeSendDataParse = JSON.parse(recipeSendData);
            ...
            _context3.next = 19;
            return (0, _sps.writeRecipeToSPS)(recipeSendDataParse, userSendData, fa_Nummer);
          case 19:
            spsResponse = _context3.sent;
            console.log('-----------*********************************************************************------------------');
          ...
          case 23:
            ...
            (0, _alerts.showAlert)('error', 'No recipe selected!');
...
var recipeSendButton_NotInlogt = document.querySelector('.btn--recipeSend_NotInlogt');
if (recipeSendForm_NotInlogt) {
  recipeSendButton_NotInlogt.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 18;
            return (0, _sps.writeRecipeToSPS_noInlogt)(recipeSendDataParse, userSendData, fa_Nummer);
          case 18:
            spsResponse = _context4.sent;
            console.log('-----------*********************************************************************------------------');
            // console.log('spsResponse: ', spsResponse); //spsResponse.data.status);
            // console.log('spsResponse.data.status: ', spsResponse.data.status);
...
if (createRecipe_ExpertJCD_DataForm) {
  createRecipe_ExpertJCD_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
      var artikelNummer_ExpertJCD, artikelName_ExpertJCD, ziehGeschwindigkeit_ExpertJCD, vDornVor_ExpertJCD, vDornZurueck_ExpertJCD, benutzerVorName_ExpertJCD, benutzerNachName_ExpertJCD, rohrAussenDurchmesserLetzterZug_ExpertJCD, rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD, rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD, rohrAussenDurchmesserTDTZug_ExpertJCD, angel_ExpertJCD, dornDurchmesserErsteStufe_ExpertJCD, dornPositionErsteStufe_ExpertJCD, dornDurchmesserZweiteStufe_ExpertJCD, dornPositionZweiteStufe_ExpertJCD, dornDurchmesserDritteStufe_ExpertJCD, dornPositionDritteStufe_ExpertJCD, fixlaenge_ExpertJCD, ausgleichstueck_ExpertJCD, mehrfachlaenge_ExpertJCD, anzahlFixlaengenProMehrfachlaenge_ExpertJCD, mindestGutanteil_ExpertJCD, profileGekoppelt_ExpertJCD, obereToleranz_ExpertJCD, untereToleranz_ExpertJCD, eigenePositionArr_ExpertJCD, eigenePositionArrRichtig_ExpertJCD, i, wandDickeArr_ExpertJCD, wandDickeStartSelect, wandDickeStartInput, wandDickeEigeneSelects, wandDickeEigeneInputs, wandDickeEndeSelect, wandDickeEndeInput, _i, select, correspondingInput, wandDickeArrRichtig_ExpertJCD, _i2, benutzerID_ExpertJCD, data_ExpertJCD;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            console.log('bin createRecipe_ExpertJCD_DataForm in index.js');
            e.preventDefault();
            artikelNummer_ExpertJCD = document.getElementById('artikelNummer').value;
            artikelName_ExpertJCD = document.getElementById('artikelName').value;
            ziehGeschwindigkeit_ExpertJCD = document.getElementById('ziehGeschwindigkeit').value;
            vDornVor_ExpertJCD = document.getElementById('vDornVor').value;
            console.log('vDornVor_ExpertJCD:', vDornVor_ExpertJCD);
            vDornZurueck_ExpertJCD = document.getElementById('vDornZurueck').value;
            console.log('vDornZurueck_ExpertJCD:', vDornZurueck_ExpertJCD);
            benutzerVorName_ExpertJCD = document.getElementById('benutzerVorName').value;
            benutzerNachName_ExpertJCD = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_ExpertJCD = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_ExpertJCD = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_ExpertJCD = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_ExpertJCD = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_ExpertJCD = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_ExpertJCD = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_ExpertJCD = document.getElementById('dornPositionZweiteStufe').value;
            dornDurchmesserDritteStufe_ExpertJCD = document.getElementById('dornDurchmesserDritteStufe').value;
            dornPositionDritteStufe_ExpertJCD = document.getElementById('dornPositionDritteStufe').value;
            fixlaenge_ExpertJCD = document.getElementById('fixlaenge').value;
            ausgleichstueck_ExpertJCD = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_ExpertJCD = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_ExpertJCD = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_ExpertJCD = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_ExpertJCD = document.getElementById('profileGekoppelt').value;
            obereToleranz_ExpertJCD = document.getElementById('obereToleranz').value;
            untereToleranz_ExpertJCD = document.getElementById('untereToleranz').value;
            console.log('artikelNummer_ExpertJCD: ' + artikelNummer_ExpertJCD);
            console.log('artikelName_ExpertJCD: ' + artikelName_ExpertJCD);
            console.log('ziehGeschwindigkeit_ExpertJCD: ' + ziehGeschwindigkeit_ExpertJCD);
            ...
            console.log('rohrAussenDurchmesserLetzterZug_ExpertJCD: ' + rohrAussenDurchmesserLetzterZug_ExpertJCD);
            console.log('rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD: ' + rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD);
            console.log('rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD: ' + rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD);
            console.log('rohrAussenDurchmesserTDTZug_ExpertJCD: ' + rohrAussenDurchmesserTDTZug_ExpertJCD);
            console.log('angel_ExpertJCD: ' + angel_ExpertJCD);
            console.log('dornDurchmesserErsteStufe_ExpertJCD: ' + dornDurchmesserErsteStufe_ExpertJCD);
            console.log('dornPositionErsteStufe_ExpertJCD: ' + dornPositionErsteStufe_ExpertJCD);
            console.log('dornDurchmesserZweiteStufe_ExpertJCD: ' + dornDurchmesserZweiteStufe_ExpertJCD);
            console.log('dornPositionZweiteStufe_ExpertJCD: ' + dornPositionZweiteStufe_ExpertJCD);
            console.log('dornDurchmesserDritteStufe_ExpertJCD: ' + dornDurchmesserDritteStufe_ExpertJCD);
            console.log('dornPositionDritteStufe_ExpertJCD: ' + dornPositionDritteStufe_ExpertJCD);
            ...
            console.log('anzahlFixlaengenProMehrfachlaenge_ExpertJCD: ' + anzahlFixlaengenProMehrfachlaenge_ExpertJCD);
            ...
            console.log('Eckenzeugs!!!!!: --------------------------------------------------------------------------');
            console.log('Positionen');
            eigenePositionArr_ExpertJCD = document.querySelectorAll('[id^="positionEcke"]');
            console.log('eigenePositionArr_ExpertJCD: ' + eigenePositionArr_ExpertJCD);
            console.log('Anzahl der gefundenen Eingabefelder: ' + eigenePositionArr_ExpertJCD.length);
            eigenePositionArrRichtig_ExpertJCD = [];
            for (i = 0; i < eigenePositionArr_ExpertJCD.length; i++) {
              console.log('eigenePositionArr_ExpertJCD[i]: ' + eigenePositionArr_ExpertJCD[i].value);
              eigenePositionArrRichtig_ExpertJCD.push(eigenePositionArr_ExpertJCD[i].value);
            }
            console.log('Wanddicke!!!!!: --------------------------------------------------------------------------');
            wandDickeArr_ExpertJCD = [];
            wandDickeStartSelect = document.getElementById('eigeneWandDickeSelectStart');
            wandDickeStartInput = document.getElementById('eigeneWandDickeInputStart');
            wandDickeEigeneSelects = document.querySelectorAll('[id^="eigeneWandDickeSelectEigene"]');
            wandDickeEigeneInputs = document.querySelectorAll('[id^="eigeneWandDickeInputEigene"]');
            wandDickeEndeSelect = document.getElementById('eigeneWandDickeSelectEnde');
            wandDickeEndeInput = document.getElementById('eigeneWandDickeInputEnde');
            if (wandDickeStartSelect) {
              if (wandDickeStartSelect.value === 'andere' || wandDickeStartSelect.value === 'other' || wandDickeStartSelect.value === 'jiny') {
                wandDickeArr_ExpertJCD.push(wandDickeStartInput);
              } else {
                wandDickeArr_ExpertJCD.push(wandDickeStartSelect);
              }
            }
            for (_i = 0; _i < wandDickeEigeneSelects.length; _i++) {
              select = wandDickeEigeneSelects[_i];
              if (select.value === 'andere' || select.value === 'other' || select.value === 'jiny') {
                correspondingInput = document.getElementById(select.id.replace('Select', 'Input')); //wandDickeArr.push(wandDickeEigeneInputs[i]);
                wandDickeArr_ExpertJCD.push(correspondingInput);
              } else {
                wandDickeArr_ExpertJCD.push(wandDickeEigeneSelects[_i]);
              }
            }
            if (wandDickeEndeSelect) {
              if (wandDickeEndeSelect.value === 'andere' || wandDickeEndeSelect.value === 'other' || wandDickeEndeSelect.value === 'jiny') {
            ...
            for (_i2 = 0; _i2 < wandDickeArr_ExpertJCD.length; _i2++) {
              console.log('wandDickeArr_ExpertJCD[i]: ' + wandDickeArr_ExpertJCD[_i2].value);
              wandDickeArrRichtig_ExpertJCD.push(wandDickeArr_ExpertJCD[_i2].value);
            }
            benutzerID_ExpertJCD = document.getElementById('benutzerID').value;
            console.log('benutzerID_ExpertJCD: ' + benutzerID_ExpertJCD);
            data_ExpertJCD = {
              artikelNummer_ExpertJCD: artikelNummer_ExpertJCD,
              artikelName_ExpertJCD: artikelName_ExpertJCD,
              ziehGeschwindigkeit_ExpertJCD: ziehGeschwindigkeit_ExpertJCD,
              vDornVor_ExpertJCD: vDornVor_ExpertJCD,
              vDornZurueck_ExpertJCD: vDornZurueck_ExpertJCD,
              benutzerVorName_ExpertJCD: benutzerVorName_ExpertJCD,
              benutzerNachName_ExpertJCD: benutzerNachName_ExpertJCD,
              benutzerID_ExpertJCD: benutzerID_ExpertJCD,
              rohrAussenDurchmesserLetzterZug_ExpertJCD: rohrAussenDurchmesserLetzterZug_ExpertJCD,
              rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD: rohrWandDickeAussenDurchmesserLetzterZug_ExpertJCD,
              rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD: rohrInnenDurchmesserLetzterZugBerechnet_ExpertJCD,
              rohrAussenDurchmesserTDTZug_ExpertJCD: rohrAussenDurchmesserTDTZug_ExpertJCD,
              angel_ExpertJCD: angel_ExpertJCD,
              dornDurchmesserErsteStufe_ExpertJCD: dornDurchmesserErsteStufe_ExpertJCD,
              dornPositionErsteStufe_ExpertJCD: dornPositionErsteStufe_ExpertJCD,
              dornDurchmesserZweiteStufe_ExpertJCD: dornDurchmesserZweiteStufe_ExpertJCD,
              dornPositionZweiteStufe_ExpertJCD: dornPositionZweiteStufe_ExpertJCD,
              dornDurchmesserDritteStufe_ExpertJCD: dornDurchmesserDritteStufe_ExpertJCD,
              dornPositionDritteStufe_ExpertJCD: dornPositionDritteStufe_ExpertJCD,
              fixlaenge_ExpertJCD: fixlaenge_ExpertJCD,
              ausgleichstueck_ExpertJCD: ausgleichstueck_ExpertJCD,
              mehrfachlaenge_ExpertJCD: mehrfachlaenge_ExpertJCD,
              anzahlFixlaengenProMehrfachlaenge_ExpertJCD: anzahlFixlaengenProMehrfachlaenge_ExpertJCD,
              mindestGutanteil_ExpertJCD: mindestGutanteil_ExpertJCD,
              profileGekoppelt_ExpertJCD: profileGekoppelt_ExpertJCD,
              obereToleranz_ExpertJCD: obereToleranz_ExpertJCD,
              untereToleranz_ExpertJCD: untereToleranz_ExpertJCD,
              //wandDickeArr_ExpertJCD,
              //eigenePositionArr_ExpertJCD,
              eigenePositionArrRichtig_ExpertJCD: eigenePositionArrRichtig_ExpertJCD,
              wandDickeArrRichtig_ExpertJCD: wandDickeArrRichtig_ExpertJCD
            };
            (0, _recipes.createRecipe_ExpertJCD)(data_ExpertJCD);
          case 78:
          case "end":
            return _context5.stop();
        }
...
if (createRecipe3_St_4_BMSMB_DataForm) {
  createRecipe3_St_4_BMSMB_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
      var artikelNummer_3_St_4_BMSMB, artikelName_3_St_4_BMSMB, ziehGeschwindigkeit_3_St_4_BMSMB, vDornVor_3_St_4_BMSMB, vDornZurueck_3_St_4_BMSMB, benutzerVorName_3_St_4_BMSMB, benutzerNachName_3_St_4_BMSMB, rohrAussenDurchmesserLetzterZug_3_St_4_BMSMB, rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_BMSMB, rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_BMSMB, rohrAussenDurchmesserTDTZug_3_St_4_BMSMB, angel_3_St_4_BMSMB, dornDurchmesserErsteStufe_3_St_4_BMSMB, dornPositionErsteStufe_3_St_4_BMSMB, dornDurchmesserZweiteStufe_3_St_4_BMSMB, dornPositionZweiteStufe_3_St_4_BMSMB, dornDurchmesserDritteStufe_3_St_4_BMSMB, dornPositionDritteStufe_3_St_4_BMSMB, fixlaenge_3_St_4_BMSMB, ausgleichstueck_3_St_4_BMSMB, mehrfachlaenge_3_St_4_BMSMB, anzahlFixlaengenProMehrfachlaenge_3_St_4_BMSMB, mindestGutanteil_3_St_4_BMSMB, profileGekoppelt_3_St_4_BMSMB, obereToleranz_3_St_4_BMSMB, untereToleranz_3_St_4_BMSMB, wanddickeEcke1_3_St_4_BMSMB, positionEcke1_3_St_4_BMSMB, wanddickeEcke2_3_St_4_BMSMB, positionEcke2_3_St_4_BMSMB, wanddickeEcke3_3_St_4_BMSMB, positionEcke3_3_St_4_BMSMB, wanddickeEcke4_3_St_4_BMSMB, positionEcke4_3_St_4_BMSMB, wanddickeEcke5_3_St_4_BMSMB, positionEcke5_3_St_4_BMSMB, wanddickeEcke6_3_St_4_BMSMB, positionEcke6_3_St_4_BMSMB, wanddickeEcke7_3_St_4_BMSMB, positionEcke7_3_St_4_BMSMB, wanddickeEcke8_3_St_4_BMSMB, positionEcke8_3_St_4_BMSMB, wanddickeEcke9_3_St_4_BMSMB, positionEcke9_3_St_4_BMSMB, wanddickeEckeEnde_3_St_4_BMSMB, positionEckeEnde_3_St_4_BMSMB, benutzerID_3_St_4_BMSMB, data_3_St_4_BMSMB;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            console.log('bin createRecipe3_St_4_BMSMB_DataForm in index.js');
            e.preventDefault();
            artikelNummer_3_St_4_BMSMB = document.getElementById('artikelNummer').value;
            artikelName_3_St_4_BMSMB = document.getElementById('artikelName').value;
            ziehGeschwindigkeit_3_St_4_BMSMB = document.getElementById('ziehGeschwindigkeit').value;
            vDornVor_3_St_4_BMSMB = document.getElementById('vDornVor').value;
            console.log('vDornVor_3_St_4_BMSMB:', vDornVor_3_St_4_BMSMB);
            vDornZurueck_3_St_4_BMSMB = document.getElementById('vDornZurueck').value;
            console.log('vDornZurueck_3_St_4_BMSMB:', vDornZurueck_3_St_4_BMSMB);
            benutzerVorName_3_St_4_BMSMB = document.getElementById('benutzerVorName').value;
            benutzerNachName_3_St_4_BMSMB = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_3_St_4_BMSMB = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_BMSMB = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_BMSMB = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_3_St_4_BMSMB = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_3_St_4_BMSMB = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_3_St_4_BMSMB = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_3_St_4_BMSMB = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_3_St_4_BMSMB = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_3_St_4_BMSMB = document.getElementById('dornPositionZweiteStufe').value;
            dornDurchmesserDritteStufe_3_St_4_BMSMB = document.getElementById('dornDurchmesserDritteStufe').value;
            dornPositionDritteStufe_3_St_4_BMSMB = document.getElementById('dornPositionDritteStufe').value;
            fixlaenge_3_St_4_BMSMB = document.getElementById('fixlaenge').value;
            ausgleichstueck_3_St_4_BMSMB = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_3_St_4_BMSMB = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_3_St_4_BMSMB = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_3_St_4_BMSMB = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_3_St_4_BMSMB = document.getElementById('profileGekoppelt').value;
            obereToleranz_3_St_4_BMSMB = document.getElementById('obereToleranz').value;
            untereToleranz_3_St_4_BMSMB = document.getElementById('untereToleranz').value;
            wanddickeEcke1_3_St_4_BMSMB = document.getElementById('wanddickeEcke1').value;
            positionEcke1_3_St_4_BMSMB = document.getElementById('positionEcke1').value;
            wanddickeEcke2_3_St_4_BMSMB = document.getElementById('wanddickeEcke2').value;
            positionEcke2_3_St_4_BMSMB = document.getElementById('positionEcke2').value;
            wanddickeEcke3_3_St_4_BMSMB = document.getElementById('wanddickeEcke3').value;
            positionEcke3_3_St_4_BMSMB = document.getElementById('positionEcke3').value;
            wanddickeEcke4_3_St_4_BMSMB = document.getElementById('wanddickeEcke4').value;
            positionEcke4_3_St_4_BMSMB = document.getElementById('positionEcke4').value;
            wanddickeEcke5_3_St_4_BMSMB = document.getElementById('wanddickeEcke5').value;
            positionEcke5_3_St_4_BMSMB = document.getElementById('positionEcke5').value;
            wanddickeEcke6_3_St_4_BMSMB = document.getElementById('wanddickeEcke6').value;
            positionEcke6_3_St_4_BMSMB = document.getElementById('positionEcke6').value; // const wanddickeEcke6Zwischen8_3_St_4_BMSMB = document.getElementById(
            //   'wanddickeEcke6Zwischen8',
            // ).value;
            // const positionEcke6Zwischen8_3_St_4_BMSMB = document.getElementById(
            //   'positionEcke6Zwischen8',
            // ).value;
            wanddickeEcke7_3_St_4_BMSMB = document.getElementById('wanddickeEcke7').value;
            positionEcke7_3_St_4_BMSMB = document.getElementById('positionEcke7').value;
            wanddickeEcke8_3_St_4_BMSMB = document.getElementById('wanddickeEcke8').value;
            positionEcke8_3_St_4_BMSMB = document.getElementById('positionEcke8').value; // const wanddickeEcke9Zwischen11_3_St_4_BMSMB = document.getElementById(
            //   'wanddickeEcke9Zwischen11',
            // ).value;
            // const positionEcke9Zwischen11_3_St_4_BMSMB = document.getElementById(
            //   'positionEcke9Zwischen11',
            // ).value;
            wanddickeEcke9_3_St_4_BMSMB = document.getElementById('wanddickeEcke9').value;
            positionEcke9_3_St_4_BMSMB = document.getElementById('positionEcke9').value;
            wanddickeEckeEnde_3_St_4_BMSMB = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde_3_St_4_BMSMB = document.getElementById('positionEckeEnde').value;
            benutzerID_3_St_4_BMSMB = document.getElementById('benutzerID').value;
            data_3_St_4_BMSMB = {
              artikelNummer_3_St_4_BMSMB: artikelNummer_3_St_4_BMSMB,
              artikelName_3_St_4_BMSMB: artikelName_3_St_4_BMSMB,
              ziehGeschwindigkeit_3_St_4_BMSMB: ziehGeschwindigkeit_3_St_4_BMSMB,
              vDornVor_3_St_4_BMSMB: vDornVor_3_St_4_BMSMB,
              vDornZurueck_3_St_4_BMSMB: vDornZurueck_3_St_4_BMSMB,
              benutzerVorName_3_St_4_BMSMB: benutzerVorName_3_St_4_BMSMB,
              benutzerNachName_3_St_4_BMSMB: benutzerNachName_3_St_4_BMSMB,
              benutzerID_3_St_4_BMSMB: benutzerID_3_St_4_BMSMB,
              rohrAussenDurchmesserLetzterZug_3_St_4_BMSMB: rohrAussenDurchmesserLetzterZug_3_St_4_BMSMB,
              rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_BMSMB: rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_BMSMB,
              rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_BMSMB: rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_BMSMB,
              rohrAussenDurchmesserTDTZug_3_St_4_BMSMB: rohrAussenDurchmesserTDTZug_3_St_4_BMSMB,
              angel_3_St_4_BMSMB: angel_3_St_4_BMSMB,
              dornDurchmesserErsteStufe_3_St_4_BMSMB: dornDurchmesserErsteStufe_3_St_4_BMSMB,
              dornPositionErsteStufe_3_St_4_BMSMB: dornPositionErsteStufe_3_St_4_BMSMB,
              dornDurchmesserZweiteStufe_3_St_4_BMSMB: dornDurchmesserZweiteStufe_3_St_4_BMSMB,
              dornPositionZweiteStufe_3_St_4_BMSMB: dornPositionZweiteStufe_3_St_4_BMSMB,
              dornDurchmesserDritteStufe_3_St_4_BMSMB: dornDurchmesserDritteStufe_3_St_4_BMSMB,
              dornPositionDritteStufe_3_St_4_BMSMB: dornPositionDritteStufe_3_St_4_BMSMB,
              fixlaenge_3_St_4_BMSMB: fixlaenge_3_St_4_BMSMB,
              ausgleichstueck_3_St_4_BMSMB: ausgleichstueck_3_St_4_BMSMB,
              mehrfachlaenge_3_St_4_BMSMB: mehrfachlaenge_3_St_4_BMSMB,
              anzahlFixlaengenProMehrfachlaenge_3_St_4_BMSMB: anzahlFixlaengenProMehrfachlaenge_3_St_4_BMSMB,
              mindestGutanteil_3_St_4_BMSMB: mindestGutanteil_3_St_4_BMSMB,
              profileGekoppelt_3_St_4_BMSMB: profileGekoppelt_3_St_4_BMSMB,
              obereToleranz_3_St_4_BMSMB: obereToleranz_3_St_4_BMSMB,
              untereToleranz_3_St_4_BMSMB: untereToleranz_3_St_4_BMSMB,
              wanddickeEcke1_3_St_4_BMSMB: wanddickeEcke1_3_St_4_BMSMB,
              positionEcke1_3_St_4_BMSMB: positionEcke1_3_St_4_BMSMB,
              wanddickeEcke2_3_St_4_BMSMB: wanddickeEcke2_3_St_4_BMSMB,
              positionEcke2_3_St_4_BMSMB: positionEcke2_3_St_4_BMSMB,
              wanddickeEcke3_3_St_4_BMSMB: wanddickeEcke3_3_St_4_BMSMB,
              positionEcke3_3_St_4_BMSMB: positionEcke3_3_St_4_BMSMB,
              wanddickeEcke4_3_St_4_BMSMB: wanddickeEcke4_3_St_4_BMSMB,
              positionEcke4_3_St_4_BMSMB: positionEcke4_3_St_4_BMSMB,
              wanddickeEcke5_3_St_4_BMSMB: wanddickeEcke5_3_St_4_BMSMB,
              positionEcke5_3_St_4_BMSMB: positionEcke5_3_St_4_BMSMB,
              wanddickeEcke6_3_St_4_BMSMB: wanddickeEcke6_3_St_4_BMSMB,
              positionEcke6_3_St_4_BMSMB: positionEcke6_3_St_4_BMSMB,
              // wanddickeEcke6Zwischen8_3_St_4_BMSMB,
              // positionEcke6Zwischen8_3_St_4_BMSMB,
              wanddickeEcke7_3_St_4_BMSMB: wanddickeEcke7_3_St_4_BMSMB,
              positionEcke7_3_St_4_BMSMB: positionEcke7_3_St_4_BMSMB,
              wanddickeEcke8_3_St_4_BMSMB: wanddickeEcke8_3_St_4_BMSMB,
              positionEcke8_3_St_4_BMSMB: positionEcke8_3_St_4_BMSMB,
              // wanddickeEcke9Zwischen11_3_St_4_BMSMB,
              // positionEcke9Zwischen11_3_St_4_BMSMB,
              wanddickeEcke9_3_St_4_BMSMB: wanddickeEcke9_3_St_4_BMSMB,
              positionEcke9_3_St_4_BMSMB: positionEcke9_3_St_4_BMSMB,
              wanddickeEckeEnde_3_St_4_BMSMB: wanddickeEckeEnde_3_St_4_BMSMB,
              positionEckeEnde_3_St_4_BMSMB: positionEckeEnde_3_St_4_BMSMB
            };
            (0, _recipes.createRecipe3_St_4_BMSMB)(data_3_St_4_BMSMB);
          case 53:
          case "end":
            return _context6.stop();
        }
...
if (createRecipe3_St_4_MBSBM_DataForm) {
  createRecipe3_St_4_MBSBM_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
      var artikelNummer_3_St_4_MBSBM, artikelName_3_St_4_MBSBM, ziehGeschwindigkeit_3_St_4_MBSBM, vDornVor_3_St_4_MBSBM, vDornZurueck_3_St_4_MBSBM, benutzerVorName_3_St_4_MBSBM, benutzerNachName_3_St_4_MBSBM, rohrAussenDurchmesserLetzterZug_3_St_4_MBSBM, rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_MBSBM, rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_MBSBM, rohrAussenDurchmesserTDTZug_3_St_4_MBSBM, angel_3_St_4_MBSBM, dornDurchmesserErsteStufe_3_St_4_MBSBM, dornPositionErsteStufe_3_St_4_MBSBM, dornDurchmesserZweiteStufe_3_St_4_MBSBM, dornPositionZweiteStufe_3_St_4_MBSBM, dornDurchmesserDritteStufe_3_St_4_MBSBM, dornPositionDritteStufe_3_St_4_MBSBM, fixlaenge_3_St_4_MBSBM, ausgleichstueck_3_St_4_MBSBM, mehrfachlaenge_3_St_4_MBSBM, anzahlFixlaengenProMehrfachlaenge_3_St_4_MBSBM, mindestGutanteil_3_St_4_MBSBM, profileGekoppelt_3_St_4_MBSBM, obereToleranz_3_St_4_MBSBM, untereToleranz_3_St_4_MBSBM, wanddickeEcke1_3_St_4_MBSBM, positionEcke1_3_St_4_MBSBM, wanddickeEcke2_3_St_4_MBSBM, positionEcke2_3_St_4_MBSBM, wanddickeEcke3_3_St_4_MBSBM, positionEcke3_3_St_4_MBSBM, wanddickeEcke4_3_St_4_MBSBM, positionEcke4_3_St_4_MBSBM, wanddickeEcke5_3_St_4_MBSBM, positionEcke5_3_St_4_MBSBM, wanddickeEcke6_3_St_4_MBSBM, positionEcke6_3_St_4_MBSBM, wanddickeEcke7_3_St_4_MBSBM, positionEcke7_3_St_4_MBSBM, wanddickeEcke8_3_St_4_MBSBM, positionEcke8_3_St_4_MBSBM, wanddickeEcke9_3_St_4_MBSBM, positionEcke9_3_St_4_MBSBM, wanddickeEckeEnde_3_St_4_MBSBM, positionEckeEnde_3_St_4_MBSBM, benutzerID_3_St_4_MBSBM, data_3_St_4_MBSBM;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            console.log('bin createRecipe3_St_4_MBSBM_DataForm in index.js');
            e.preventDefault();
            artikelNummer_3_St_4_MBSBM = document.getElementById('artikelNummer').value;
            artikelName_3_St_4_MBSBM = document.getElementById('artikelName').value;
            ziehGeschwindigkeit_3_St_4_MBSBM = document.getElementById('ziehGeschwindigkeit').value;
            vDornVor_3_St_4_MBSBM = document.getElementById('vDornVor').value;
            console.log('vDornVor_3_St_4_MBSBM:', vDornVor_3_St_4_MBSBM);
            vDornZurueck_3_St_4_MBSBM = document.getElementById('vDornZurueck').value;
            console.log('vDornZurueck_3_St_4_MBSBM:', vDornZurueck_3_St_4_MBSBM);
            benutzerVorName_3_St_4_MBSBM = document.getElementById('benutzerVorName').value;
            benutzerNachName_3_St_4_MBSBM = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_3_St_4_MBSBM = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_MBSBM = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_MBSBM = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_3_St_4_MBSBM = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_3_St_4_MBSBM = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_3_St_4_MBSBM = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_3_St_4_MBSBM = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_3_St_4_MBSBM = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_3_St_4_MBSBM = document.getElementById('dornPositionZweiteStufe').value;
            dornDurchmesserDritteStufe_3_St_4_MBSBM = document.getElementById('dornDurchmesserDritteStufe').value;
            dornPositionDritteStufe_3_St_4_MBSBM = document.getElementById('dornPositionDritteStufe').value;
            fixlaenge_3_St_4_MBSBM = document.getElementById('fixlaenge').value;
            ausgleichstueck_3_St_4_MBSBM = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_3_St_4_MBSBM = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_3_St_4_MBSBM = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_3_St_4_MBSBM = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_3_St_4_MBSBM = document.getElementById('profileGekoppelt').value;
            obereToleranz_3_St_4_MBSBM = document.getElementById('obereToleranz').value;
            untereToleranz_3_St_4_MBSBM = document.getElementById('untereToleranz').value;
            wanddickeEcke1_3_St_4_MBSBM = document.getElementById('wanddickeEcke1').value;
            positionEcke1_3_St_4_MBSBM = document.getElementById('positionEcke1').value;
            wanddickeEcke2_3_St_4_MBSBM = document.getElementById('wanddickeEcke2').value;
            positionEcke2_3_St_4_MBSBM = document.getElementById('positionEcke2').value; // const wanddickeEcke2Zwischen4_3_St_4_MBSBM = document.getElementById(
            //   'wanddickeEcke2Zwischen4',
            // ).value;
            // const positionEcke2Zwischen4_3_St_4_MBSBM = document.getElementById(
            //   'positionEcke2Zwischen4',
            // ).value;
            wanddickeEcke3_3_St_4_MBSBM = document.getElementById('wanddickeEcke3').value;
            positionEcke3_3_St_4_MBSBM = document.getElementById('positionEcke3').value;
            wanddickeEcke4_3_St_4_MBSBM = document.getElementById('wanddickeEcke4').value;
            positionEcke4_3_St_4_MBSBM = document.getElementById('positionEcke4').value;
            wanddickeEcke5_3_St_4_MBSBM = document.getElementById('wanddickeEcke5').value;
            positionEcke5_3_St_4_MBSBM = document.getElementById('positionEcke5').value;
            wanddickeEcke6_3_St_4_MBSBM = document.getElementById('wanddickeEcke6').value;
            positionEcke6_3_St_4_MBSBM = document.getElementById('positionEcke6').value; // const wanddickeEcke7Zwischen9_3_St_4_MBSBM = document.getElementById(
            //   'wanddickeEcke7Zwischen9',
            // ).value;
            // const positionEcke7Zwischen9_3_St_4_MBSBM = document.getElementById(
            //   'positionEcke7Zwischen9',
            // ).value;
            wanddickeEcke7_3_St_4_MBSBM = document.getElementById('wanddickeEcke7').value;
            positionEcke7_3_St_4_MBSBM = document.getElementById('positionEcke7').value;
            wanddickeEcke8_3_St_4_MBSBM = document.getElementById('wanddickeEcke8').value;
            positionEcke8_3_St_4_MBSBM = document.getElementById('positionEcke8').value;
            wanddickeEcke9_3_St_4_MBSBM = document.getElementById('wanddickeEcke9').value;
            positionEcke9_3_St_4_MBSBM = document.getElementById('positionEcke9').value;
            wanddickeEckeEnde_3_St_4_MBSBM = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde_3_St_4_MBSBM = document.getElementById('positionEckeEnde').value;
            benutzerID_3_St_4_MBSBM = document.getElementById('benutzerID').value;
            data_3_St_4_MBSBM = {
              artikelNummer_3_St_4_MBSBM: artikelNummer_3_St_4_MBSBM,
              artikelName_3_St_4_MBSBM: artikelName_3_St_4_MBSBM,
              ziehGeschwindigkeit_3_St_4_MBSBM: ziehGeschwindigkeit_3_St_4_MBSBM,
              vDornVor_3_St_4_MBSBM: vDornVor_3_St_4_MBSBM,
              vDornZurueck_3_St_4_MBSBM: vDornZurueck_3_St_4_MBSBM,
              benutzerVorName_3_St_4_MBSBM: benutzerVorName_3_St_4_MBSBM,
              benutzerNachName_3_St_4_MBSBM: benutzerNachName_3_St_4_MBSBM,
              benutzerID_3_St_4_MBSBM: benutzerID_3_St_4_MBSBM,
              rohrAussenDurchmesserLetzterZug_3_St_4_MBSBM: rohrAussenDurchmesserLetzterZug_3_St_4_MBSBM,
              rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_MBSBM: rohrWandDickeAussenDurchmesserLetzterZug_3_St_4_MBSBM,
              rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_MBSBM: rohrInnenDurchmesserLetzterZugBerechnet_3_St_4_MBSBM,
              rohrAussenDurchmesserTDTZug_3_St_4_MBSBM: rohrAussenDurchmesserTDTZug_3_St_4_MBSBM,
              angel_3_St_4_MBSBM: angel_3_St_4_MBSBM,
              dornDurchmesserErsteStufe_3_St_4_MBSBM: dornDurchmesserErsteStufe_3_St_4_MBSBM,
              dornPositionErsteStufe_3_St_4_MBSBM: dornPositionErsteStufe_3_St_4_MBSBM,
              dornDurchmesserZweiteStufe_3_St_4_MBSBM: dornDurchmesserZweiteStufe_3_St_4_MBSBM,
              dornPositionZweiteStufe_3_St_4_MBSBM: dornPositionZweiteStufe_3_St_4_MBSBM,
              dornDurchmesserDritteStufe_3_St_4_MBSBM: dornDurchmesserDritteStufe_3_St_4_MBSBM,
              dornPositionDritteStufe_3_St_4_MBSBM: dornPositionDritteStufe_3_St_4_MBSBM,
              fixlaenge_3_St_4_MBSBM: fixlaenge_3_St_4_MBSBM,
              ausgleichstueck_3_St_4_MBSBM: ausgleichstueck_3_St_4_MBSBM,
              mehrfachlaenge_3_St_4_MBSBM: mehrfachlaenge_3_St_4_MBSBM,
              anzahlFixlaengenProMehrfachlaenge_3_St_4_MBSBM: anzahlFixlaengenProMehrfachlaenge_3_St_4_MBSBM,
              mindestGutanteil_3_St_4_MBSBM: mindestGutanteil_3_St_4_MBSBM,
              profileGekoppelt_3_St_4_MBSBM: profileGekoppelt_3_St_4_MBSBM,
              obereToleranz_3_St_4_MBSBM: obereToleranz_3_St_4_MBSBM,
              untereToleranz_3_St_4_MBSBM: untereToleranz_3_St_4_MBSBM,
              wanddickeEcke1_3_St_4_MBSBM: wanddickeEcke1_3_St_4_MBSBM,
              positionEcke1_3_St_4_MBSBM: positionEcke1_3_St_4_MBSBM,
              wanddickeEcke2_3_St_4_MBSBM: wanddickeEcke2_3_St_4_MBSBM,
              positionEcke2_3_St_4_MBSBM: positionEcke2_3_St_4_MBSBM,
              // wanddickeEcke2Zwischen4_3_St_4_MBSBM,
              // positionEcke2Zwischen4_3_St_4_MBSBM,

              wanddickeEcke3_3_St_4_MBSBM: wanddickeEcke3_3_St_4_MBSBM,
              positionEcke3_3_St_4_MBSBM: positionEcke3_3_St_4_MBSBM,
              wanddickeEcke4_3_St_4_MBSBM: wanddickeEcke4_3_St_4_MBSBM,
              positionEcke4_3_St_4_MBSBM: positionEcke4_3_St_4_MBSBM,
              wanddickeEcke5_3_St_4_MBSBM: wanddickeEcke5_3_St_4_MBSBM,
              positionEcke5_3_St_4_MBSBM: positionEcke5_3_St_4_MBSBM,
              wanddickeEcke6_3_St_4_MBSBM: wanddickeEcke6_3_St_4_MBSBM,
              positionEcke6_3_St_4_MBSBM: positionEcke6_3_St_4_MBSBM,
              // wanddickeEcke7Zwischen9_3_St_4_MBSBM,
              // positionEcke7Zwischen9_3_St_4_MBSBM,

              wanddickeEcke7_3_St_4_MBSBM: wanddickeEcke7_3_St_4_MBSBM,
              positionEcke7_3_St_4_MBSBM: positionEcke7_3_St_4_MBSBM,
              wanddickeEcke8_3_St_4_MBSBM: wanddickeEcke8_3_St_4_MBSBM,
              positionEcke8_3_St_4_MBSBM: positionEcke8_3_St_4_MBSBM,
              wanddickeEcke9_3_St_4_MBSBM: wanddickeEcke9_3_St_4_MBSBM,
              positionEcke9_3_St_4_MBSBM: positionEcke9_3_St_4_MBSBM,
              wanddickeEckeEnde_3_St_4_MBSBM: wanddickeEckeEnde_3_St_4_MBSBM,
              positionEckeEnde_3_St_4_MBSBM: positionEckeEnde_3_St_4_MBSBM
            };
            (0, _recipes.createRecipe3_St_4_MBSBM)(data_3_St_4_MBSBM);
          case 53:
          case "end":
            return _context7.stop();
        }
...
if (createRecipe2_St_6_BSBSBSB_DataForm) {
  createRecipe2_St_6_BSBSBSB_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(e) {
      var artikelNummer_2_St_6_BSBSBSB, artikelName_2_St_6_BSBSBSB, ziehGeschwindigkeit_2_St_6_BSBSBSB, vDornVor_2_St_6_BSBSBSB, vDornZurueck_2_St_6_BSBSBSB, benutzerVorName_2_St_6_BSBSBSB, benutzerNachName_2_St_6_BSBSBSB, rohrAussenDurchmesserLetzterZug_2_St_6_BSBSBSB, rohrWandDickeAussenDurchmesserLetzterZug_2_St_6_BSBSBSB, rohrInnenDurchmesserLetzterZugBerechnet_2_St_6_BSBSBSB, rohrAussenDurchmesserTDTZug_2_St_6_BSBSBSB, angel_2_St_6_BSBSBSB, dornDurchmesserErsteStufe_2_St_6_BSBSBSB, dornPositionErsteStufe_2_St_6_BSBSBSB, dornDurchmesserZweiteStufe_2_St_6_BSBSBSB, dornPositionZweiteStufe_2_St_6_BSBSBSB, fixlaenge_2_St_6_BSBSBSB, ausgleichstueck_2_St_6_BSBSBSB, mehrfachlaenge_2_St_6_BSBSBSB, anzahlFixlaengenProMehrfachlaenge_2_St_6_BSBSBSB, mindestGutanteil_2_St_6_BSBSBSB, profileGekoppelt_2_St_6_BSBSBSB, obereToleranz_2_St_6_BSBSBSB, untereToleranz_2_St_6_BSBSBSB, wanddickeEcke1_2_St_6_BSBSBSB, positionEcke1_2_St_6_BSBSBSB, wanddickeEcke2_2_St_6_BSBSBSB, positionEcke2_2_St_6_BSBSBSB, wanddickeEcke3_2_St_6_BSBSBSB, positionEcke3_2_St_6_BSBSBSB, wanddickeEcke4_2_St_6_BSBSBSB, positionEcke4_2_St_6_BSBSBSB, wanddickeEcke5_2_St_6_BSBSBSB, positionEcke5_2_St_6_BSBSBSB, wanddickeEcke6_2_St_6_BSBSBSB, positionEcke6_2_St_6_BSBSBSB, wanddickeEcke7_2_St_6_BSBSBSB, positionEcke7_2_St_6_BSBSBSB, wanddickeEcke8_2_St_6_BSBSBSB, positionEcke8_2_St_6_BSBSBSB, wanddickeEcke9_2_St_6_BSBSBSB, positionEcke9_2_St_6_BSBSBSB, wanddickeEcke10_2_St_6_BSBSBSB, positionEcke10_2_St_6_BSBSBSB, wanddickeEcke11_2_St_6_BSBSBSB, positionEcke11_2_St_6_BSBSBSB, wanddickeEcke12_2_St_6_BSBSBSB, positionEcke12_2_St_6_BSBSBSB, wanddickeEcke13_2_St_6_BSBSBSB, positionEcke13_2_St_6_BSBSBSB, wanddickeEckeEnde_2_St_6_BSBSBSB, positionEckeEnde_2_St_6_BSBSBSB, benutzerID_2_St_6_BSBSBSB, data_2_St_6_BSBSBSB;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            console.log('bin createRecipe2_St_6_BSBSBSB_DataForm in index.js');
            e.preventDefault();
            artikelNummer_2_St_6_BSBSBSB = document.getElementById('artikelNummer').value;
            artikelName_2_St_6_BSBSBSB = document.getElementById('artikelName').value;
            ziehGeschwindigkeit_2_St_6_BSBSBSB = document.getElementById('ziehGeschwindigkeit').value;
            vDornVor_2_St_6_BSBSBSB = document.getElementById('vDornVor').value;
            console.log('vDornVor_2_St_6_BSBSBSB:', vDornVor_2_St_6_BSBSBSB);
            vDornZurueck_2_St_6_BSBSBSB = document.getElementById('vDornZurueck').value;
            console.log('vDornZurueck_2_St_6_BSBSBSB:', vDornZurueck_2_St_6_BSBSBSB);
            benutzerVorName_2_St_6_BSBSBSB = document.getElementById('benutzerVorName').value;
            benutzerNachName_2_St_6_BSBSBSB = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_2_St_6_BSBSBSB = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_2_St_6_BSBSBSB = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_2_St_6_BSBSBSB = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_2_St_6_BSBSBSB = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_2_St_6_BSBSBSB = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_2_St_6_BSBSBSB = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_2_St_6_BSBSBSB = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_2_St_6_BSBSBSB = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_2_St_6_BSBSBSB = document.getElementById('dornPositionZweiteStufe').value;
            fixlaenge_2_St_6_BSBSBSB = document.getElementById('fixlaenge').value;
            ausgleichstueck_2_St_6_BSBSBSB = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_2_St_6_BSBSBSB = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_2_St_6_BSBSBSB = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_2_St_6_BSBSBSB = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_2_St_6_BSBSBSB = document.getElementById('profileGekoppelt').value;
            obereToleranz_2_St_6_BSBSBSB = document.getElementById('obereToleranz').value;
            untereToleranz_2_St_6_BSBSBSB = document.getElementById('untereToleranz').value;
            wanddickeEcke1_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke1').value;
            positionEcke1_2_St_6_BSBSBSB = document.getElementById('positionEcke1').value;
            wanddickeEcke2_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke2').value;
            positionEcke2_2_St_6_BSBSBSB = document.getElementById('positionEcke2').value;
            wanddickeEcke3_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke3').value;
            positionEcke3_2_St_6_BSBSBSB = document.getElementById('positionEcke3').value;
            wanddickeEcke4_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke4').value;
            positionEcke4_2_St_6_BSBSBSB = document.getElementById('positionEcke4').value; // const wanddickeEcke4Zwischen6_2_St_6_BSBSBSB = document.getElementById(
            //   'wanddickeEcke4Zwischen6',
            // ).value;
            // const positionEcke4Zwischen6_2_St_6_BSBSBSB = document.getElementById(
            //   'positionEcke4Zwischen6',
            // ).value;
            wanddickeEcke5_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke5').value;
            positionEcke5_2_St_6_BSBSBSB = document.getElementById('positionEcke5').value;
            wanddickeEcke6_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke6').value;
            positionEcke6_2_St_6_BSBSBSB = document.getElementById('positionEcke6').value;
            wanddickeEcke7_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke7').value;
            positionEcke7_2_St_6_BSBSBSB = document.getElementById('positionEcke7').value;
            wanddickeEcke8_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke8').value;
            positionEcke8_2_St_6_BSBSBSB = document.getElementById('positionEcke8').value; // const wanddickeEcke9Zwischen11_2_St_6_BSBSBSB = document.getElementById(
            //   'wanddickeEcke9Zwischen11',
            // ).value;
            // const positionEcke9Zwischen11_2_St_6_BSBSBSB = document.getElementById(
            //   'positionEcke9Zwischen11',
            // ).value;
            wanddickeEcke9_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke9').value;
            positionEcke9_2_St_6_BSBSBSB = document.getElementById('positionEcke9').value;
            wanddickeEcke10_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke10').value;
            positionEcke10_2_St_6_BSBSBSB = document.getElementById('positionEcke10').value;
            wanddickeEcke11_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke11').value;
            positionEcke11_2_St_6_BSBSBSB = document.getElementById('positionEcke11').value;
            wanddickeEcke12_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke12').value;
            positionEcke12_2_St_6_BSBSBSB = document.getElementById('positionEcke12').value; // const wanddickeEcke14Zwischen16_2_St_6_BSBSBSB = document.getElementById(
            //   'wanddickeEcke14Zwischen16',
            // ).value;
            // const positionEcke14Zwischen16_2_St_6_BSBSBSB = document.getElementById(
            //   'positionEcke14Zwischen16',
            // ).value;
            wanddickeEcke13_2_St_6_BSBSBSB = document.getElementById('wanddickeEcke13').value;
            positionEcke13_2_St_6_BSBSBSB = document.getElementById('positionEcke13').value;
            wanddickeEckeEnde_2_St_6_BSBSBSB = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde_2_St_6_BSBSBSB = document.getElementById('positionEckeEnde').value;
            benutzerID_2_St_6_BSBSBSB = document.getElementById('benutzerID').value;
            data_2_St_6_BSBSBSB = {
              artikelNummer_2_St_6_BSBSBSB: artikelNummer_2_St_6_BSBSBSB,
              artikelName_2_St_6_BSBSBSB: artikelName_2_St_6_BSBSBSB,
              ziehGeschwindigkeit_2_St_6_BSBSBSB: ziehGeschwindigkeit_2_St_6_BSBSBSB,
              vDornVor_2_St_6_BSBSBSB: vDornVor_2_St_6_BSBSBSB,
              vDornZurueck_2_St_6_BSBSBSB: vDornZurueck_2_St_6_BSBSBSB,
              benutzerVorName_2_St_6_BSBSBSB: benutzerVorName_2_St_6_BSBSBSB,
              benutzerNachName_2_St_6_BSBSBSB: benutzerNachName_2_St_6_BSBSBSB,
              benutzerID_2_St_6_BSBSBSB: benutzerID_2_St_6_BSBSBSB,
              rohrAussenDurchmesserLetzterZug_2_St_6_BSBSBSB: rohrAussenDurchmesserLetzterZug_2_St_6_BSBSBSB,
              rohrWandDickeAussenDurchmesserLetzterZug_2_St_6_BSBSBSB: rohrWandDickeAussenDurchmesserLetzterZug_2_St_6_BSBSBSB,
              rohrInnenDurchmesserLetzterZugBerechnet_2_St_6_BSBSBSB: rohrInnenDurchmesserLetzterZugBerechnet_2_St_6_BSBSBSB,
              rohrAussenDurchmesserTDTZug_2_St_6_BSBSBSB: rohrAussenDurchmesserTDTZug_2_St_6_BSBSBSB,
              angel_2_St_6_BSBSBSB: angel_2_St_6_BSBSBSB,
              dornDurchmesserErsteStufe_2_St_6_BSBSBSB: dornDurchmesserErsteStufe_2_St_6_BSBSBSB,
              dornPositionErsteStufe_2_St_6_BSBSBSB: dornPositionErsteStufe_2_St_6_BSBSBSB,
              dornDurchmesserZweiteStufe_2_St_6_BSBSBSB: dornDurchmesserZweiteStufe_2_St_6_BSBSBSB,
              dornPositionZweiteStufe_2_St_6_BSBSBSB: dornPositionZweiteStufe_2_St_6_BSBSBSB,
              fixlaenge_2_St_6_BSBSBSB: fixlaenge_2_St_6_BSBSBSB,
              ausgleichstueck_2_St_6_BSBSBSB: ausgleichstueck_2_St_6_BSBSBSB,
              mehrfachlaenge_2_St_6_BSBSBSB: mehrfachlaenge_2_St_6_BSBSBSB,
              anzahlFixlaengenProMehrfachlaenge_2_St_6_BSBSBSB: anzahlFixlaengenProMehrfachlaenge_2_St_6_BSBSBSB,
              mindestGutanteil_2_St_6_BSBSBSB: mindestGutanteil_2_St_6_BSBSBSB,
              profileGekoppelt_2_St_6_BSBSBSB: profileGekoppelt_2_St_6_BSBSBSB,
              obereToleranz_2_St_6_BSBSBSB: obereToleranz_2_St_6_BSBSBSB,
              untereToleranz_2_St_6_BSBSBSB: untereToleranz_2_St_6_BSBSBSB,
              wanddickeEcke1_2_St_6_BSBSBSB: wanddickeEcke1_2_St_6_BSBSBSB,
              positionEcke1_2_St_6_BSBSBSB: positionEcke1_2_St_6_BSBSBSB,
              wanddickeEcke2_2_St_6_BSBSBSB: wanddickeEcke2_2_St_6_BSBSBSB,
              positionEcke2_2_St_6_BSBSBSB: positionEcke2_2_St_6_BSBSBSB,
              wanddickeEcke3_2_St_6_BSBSBSB: wanddickeEcke3_2_St_6_BSBSBSB,
              positionEcke3_2_St_6_BSBSBSB: positionEcke3_2_St_6_BSBSBSB,
              wanddickeEcke4_2_St_6_BSBSBSB: wanddickeEcke4_2_St_6_BSBSBSB,
              positionEcke4_2_St_6_BSBSBSB: positionEcke4_2_St_6_BSBSBSB,
              // wanddickeEcke4Zwischen6_2_St_6_BSBSBSB,
              // positionEcke4Zwischen6_2_St_6_BSBSBSB,
              wanddickeEcke5_2_St_6_BSBSBSB: wanddickeEcke5_2_St_6_BSBSBSB,
              positionEcke5_2_St_6_BSBSBSB: positionEcke5_2_St_6_BSBSBSB,
              wanddickeEcke6_2_St_6_BSBSBSB: wanddickeEcke6_2_St_6_BSBSBSB,
              positionEcke6_2_St_6_BSBSBSB: positionEcke6_2_St_6_BSBSBSB,
              wanddickeEcke7_2_St_6_BSBSBSB: wanddickeEcke7_2_St_6_BSBSBSB,
              positionEcke7_2_St_6_BSBSBSB: positionEcke7_2_St_6_BSBSBSB,
              wanddickeEcke8_2_St_6_BSBSBSB: wanddickeEcke8_2_St_6_BSBSBSB,
              positionEcke8_2_St_6_BSBSBSB: positionEcke8_2_St_6_BSBSBSB,
              // wanddickeEcke9Zwischen11_2_St_6_BSBSBSB,
              // positionEcke9Zwischen11_2_St_6_BSBSBSB,
              wanddickeEcke9_2_St_6_BSBSBSB: wanddickeEcke9_2_St_6_BSBSBSB,
              positionEcke9_2_St_6_BSBSBSB: positionEcke9_2_St_6_BSBSBSB,
              wanddickeEcke10_2_St_6_BSBSBSB: wanddickeEcke10_2_St_6_BSBSBSB,
              positionEcke10_2_St_6_BSBSBSB: positionEcke10_2_St_6_BSBSBSB,
              wanddickeEcke11_2_St_6_BSBSBSB: wanddickeEcke11_2_St_6_BSBSBSB,
              positionEcke11_2_St_6_BSBSBSB: positionEcke11_2_St_6_BSBSBSB,
              wanddickeEcke12_2_St_6_BSBSBSB: wanddickeEcke12_2_St_6_BSBSBSB,
              positionEcke12_2_St_6_BSBSBSB: positionEcke12_2_St_6_BSBSBSB,
              // wanddickeEcke14Zwischen16_2_St_6_BSBSBSB,
              // positionEcke14Zwischen16_2_St_6_BSBSBSB,
              wanddickeEcke13_2_St_6_BSBSBSB: wanddickeEcke13_2_St_6_BSBSBSB,
              positionEcke13_2_St_6_BSBSBSB: positionEcke13_2_St_6_BSBSBSB,
              wanddickeEckeEnde_2_St_6_BSBSBSB: wanddickeEckeEnde_2_St_6_BSBSBSB,
              positionEckeEnde_2_St_6_BSBSBSB: positionEckeEnde_2_St_6_BSBSBSB
            };
            (0, _recipes.createRecipe2_St_6_BSBSBSB)(data_2_St_6_BSBSBSB);
          case 59:
          case "end":
            return _context8.stop();
        }
...
if (createRecipe2_St_4_SBSBS_DataForm) {
  createRecipe2_St_4_SBSBS_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(e) {
      var artikelNummer_2_St_4_SBSBS, artikelName_2_St_4_SBSBS, ziehGeschwindigkeit_2_St_4_SBSBS, vDornVor_2_St_4_SBSBS, vDornZurueck_2_St_4_SBSBS, benutzerVorName_2_St_4_SBSBS, benutzerNachName_2_St_4_SBSBS, rohrAussenDurchmesserLetzterZug_2_St_4_SBSBS, rohrWandDickeAussenDurchmesserLetzterZug_2_St_4_SBSBS, rohrInnenDurchmesserLetzterZugBerechnet_2_St_4_SBSBS, rohrAussenDurchmesserTDTZug_2_St_4_SBSBS, angel_2_St_4_SBSBS, dornDurchmesserErsteStufe_2_St_4_SBSBS, dornPositionErsteStufe_2_St_4_SBSBS, dornDurchmesserZweiteStufe_2_St_4_SBSBS, dornPositionZweiteStufe_2_St_4_SBSBS, fixlaenge_2_St_4_SBSBS, ausgleichstueck_2_St_4_SBSBS, mehrfachlaenge_2_St_4_SBSBS, anzahlFixlaengenProMehrfachlaenge_2_St_4_SBSBS, mindestGutanteil_2_St_4_SBSBS, profileGekoppelt_2_St_4_SBSBS, obereToleranz_2_St_4_SBSBS, untereToleranz_2_St_4_SBSBS, wanddickeEcke1_2_St_4_SBSBS, positionEcke1_2_St_4_SBSBS, wanddickeEcke2_2_St_4_SBSBS, positionEcke2_2_St_4_SBSBS, wanddickeEcke3_2_St_4_SBSBS, positionEcke3_2_St_4_SBSBS, wanddickeEcke4_2_St_4_SBSBS, positionEcke4_2_St_4_SBSBS, wanddickeEcke5_2_St_4_SBSBS, positionEcke5_2_St_4_SBSBS, wanddickeEcke6_2_St_4_SBSBS, positionEcke6_2_St_4_SBSBS, wanddickeEcke7_2_St_4_SBSBS, positionEcke7_2_St_4_SBSBS, wanddickeEcke8_2_St_4_SBSBS, positionEcke8_2_St_4_SBSBS, wanddickeEcke9_2_St_4_SBSBS, positionEcke9_2_St_4_SBSBS, wanddickeEckeEnde_2_St_4_SBSBS, positionEckeEnde_2_St_4_SBSBS, benutzerID_2_St_4_SBSBS, data_2_St_4_SBSBS;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            console.log('bin createRecipe2_St_4_SBSBS_DataForm in index.js');
            e.preventDefault();
            artikelNummer_2_St_4_SBSBS = document.getElementById('artikelNummer').value;
            artikelName_2_St_4_SBSBS = document.getElementById('artikelName').value;
            ziehGeschwindigkeit_2_St_4_SBSBS = document.getElementById('ziehGeschwindigkeit').value;
            vDornVor_2_St_4_SBSBS = document.getElementById('vDornVor').value;
            vDornZurueck_2_St_4_SBSBS = document.getElementById('vDornZurueck').value;
            console.log('vDornVor_2_St_4_SBSBS:', vDornVor_2_St_4_SBSBS);
            console.log('vDornZurueck_2_St_4_SBSBS:', vDornZurueck_2_St_4_SBSBS);
            benutzerVorName_2_St_4_SBSBS = document.getElementById('benutzerVorName').value;
            benutzerNachName_2_St_4_SBSBS = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_2_St_4_SBSBS = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_2_St_4_SBSBS = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_2_St_4_SBSBS = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_2_St_4_SBSBS = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_2_St_4_SBSBS = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_2_St_4_SBSBS = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_2_St_4_SBSBS = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_2_St_4_SBSBS = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_2_St_4_SBSBS = document.getElementById('dornPositionZweiteStufe').value;
            fixlaenge_2_St_4_SBSBS = document.getElementById('fixlaenge').value;
            ausgleichstueck_2_St_4_SBSBS = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_2_St_4_SBSBS = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_2_St_4_SBSBS = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_2_St_4_SBSBS = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_2_St_4_SBSBS = document.getElementById('profileGekoppelt').value;
            obereToleranz_2_St_4_SBSBS = document.getElementById('obereToleranz').value;
            untereToleranz_2_St_4_SBSBS = document.getElementById('untereToleranz').value;
            wanddickeEcke1_2_St_4_SBSBS = document.getElementById('wanddickeEcke1').value;
            positionEcke1_2_St_4_SBSBS = document.getElementById('positionEcke1').value;
            wanddickeEcke2_2_St_4_SBSBS = document.getElementById('wanddickeEcke2').value;
            positionEcke2_2_St_4_SBSBS = document.getElementById('positionEcke2').value; // const wanddickeEcke2Zwischen4_2_St_4_SBSBS = document.getElementById(
            //   'wanddickeEcke2Zwischen4',
            // ).value;
            // const positionEcke2Zwischen4_2_St_4_SBSBS = document.getElementById(
            //   'positionEcke2Zwischen4',
            // ).value;
            wanddickeEcke3_2_St_4_SBSBS = document.getElementById('wanddickeEcke3').value;
            positionEcke3_2_St_4_SBSBS = document.getElementById('positionEcke3').value;
            wanddickeEcke4_2_St_4_SBSBS = document.getElementById('wanddickeEcke4').value;
            positionEcke4_2_St_4_SBSBS = document.getElementById('positionEcke4').value;
            wanddickeEcke5_2_St_4_SBSBS = document.getElementById('wanddickeEcke5').value;
            positionEcke5_2_St_4_SBSBS = document.getElementById('positionEcke5').value;
            wanddickeEcke6_2_St_4_SBSBS = document.getElementById('wanddickeEcke6').value;
            positionEcke6_2_St_4_SBSBS = document.getElementById('positionEcke6').value; // const wanddickeEcke7Zwischen9_2_St_4_SBSBS = document.getElementById(
            //   'wanddickeEcke7Zwischen9',
            // ).value;
            // const positionEcke7Zwischen9_2_St_4_SBSBS = document.getElementById(
            //   'positionEcke7Zwischen9',
            // ).value;
            wanddickeEcke7_2_St_4_SBSBS = document.getElementById('wanddickeEcke7').value;
            positionEcke7_2_St_4_SBSBS = document.getElementById('positionEcke7').value;
            wanddickeEcke8_2_St_4_SBSBS = document.getElementById('wanddickeEcke8').value;
            positionEcke8_2_St_4_SBSBS = document.getElementById('positionEcke8').value;
            wanddickeEcke9_2_St_4_SBSBS = document.getElementById('wanddickeEcke9').value;
            positionEcke9_2_St_4_SBSBS = document.getElementById('positionEcke9').value;
            wanddickeEckeEnde_2_St_4_SBSBS = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde_2_St_4_SBSBS = document.getElementById('positionEckeEnde').value;
            benutzerID_2_St_4_SBSBS = document.getElementById('benutzerID').value;
            data_2_St_4_SBSBS = {
              artikelNummer_2_St_4_SBSBS: artikelNummer_2_St_4_SBSBS,
              artikelName_2_St_4_SBSBS: artikelName_2_St_4_SBSBS,
              ziehGeschwindigkeit_2_St_4_SBSBS: ziehGeschwindigkeit_2_St_4_SBSBS,
              vDornVor_2_St_4_SBSBS: vDornVor_2_St_4_SBSBS,
              vDornZurueck_2_St_4_SBSBS: vDornZurueck_2_St_4_SBSBS,
              benutzerVorName_2_St_4_SBSBS: benutzerVorName_2_St_4_SBSBS,
              benutzerNachName_2_St_4_SBSBS: benutzerNachName_2_St_4_SBSBS,
              benutzerID_2_St_4_SBSBS: benutzerID_2_St_4_SBSBS,
              rohrAussenDurchmesserLetzterZug_2_St_4_SBSBS: rohrAussenDurchmesserLetzterZug_2_St_4_SBSBS,
              rohrWandDickeAussenDurchmesserLetzterZug_2_St_4_SBSBS: rohrWandDickeAussenDurchmesserLetzterZug_2_St_4_SBSBS,
              rohrInnenDurchmesserLetzterZugBerechnet_2_St_4_SBSBS: rohrInnenDurchmesserLetzterZugBerechnet_2_St_4_SBSBS,
              rohrAussenDurchmesserTDTZug_2_St_4_SBSBS: rohrAussenDurchmesserTDTZug_2_St_4_SBSBS,
              angel_2_St_4_SBSBS: angel_2_St_4_SBSBS,
              dornDurchmesserErsteStufe_2_St_4_SBSBS: dornDurchmesserErsteStufe_2_St_4_SBSBS,
              dornPositionErsteStufe_2_St_4_SBSBS: dornPositionErsteStufe_2_St_4_SBSBS,
              dornDurchmesserZweiteStufe_2_St_4_SBSBS: dornDurchmesserZweiteStufe_2_St_4_SBSBS,
              dornPositionZweiteStufe_2_St_4_SBSBS: dornPositionZweiteStufe_2_St_4_SBSBS,
              fixlaenge_2_St_4_SBSBS: fixlaenge_2_St_4_SBSBS,
              ausgleichstueck_2_St_4_SBSBS: ausgleichstueck_2_St_4_SBSBS,
              mehrfachlaenge_2_St_4_SBSBS: mehrfachlaenge_2_St_4_SBSBS,
              anzahlFixlaengenProMehrfachlaenge_2_St_4_SBSBS: anzahlFixlaengenProMehrfachlaenge_2_St_4_SBSBS,
              mindestGutanteil_2_St_4_SBSBS: mindestGutanteil_2_St_4_SBSBS,
              profileGekoppelt_2_St_4_SBSBS: profileGekoppelt_2_St_4_SBSBS,
              obereToleranz_2_St_4_SBSBS: obereToleranz_2_St_4_SBSBS,
              untereToleranz_2_St_4_SBSBS: untereToleranz_2_St_4_SBSBS,
              wanddickeEcke1_2_St_4_SBSBS: wanddickeEcke1_2_St_4_SBSBS,
              positionEcke1_2_St_4_SBSBS: positionEcke1_2_St_4_SBSBS,
              wanddickeEcke2_2_St_4_SBSBS: wanddickeEcke2_2_St_4_SBSBS,
              positionEcke2_2_St_4_SBSBS: positionEcke2_2_St_4_SBSBS,
              // wanddickeEcke2Zwischen4_2_St_4_SBSBS,
              // positionEcke2Zwischen4_2_St_4_SBSBS,
              wanddickeEcke3_2_St_4_SBSBS: wanddickeEcke3_2_St_4_SBSBS,
              positionEcke3_2_St_4_SBSBS: positionEcke3_2_St_4_SBSBS,
              wanddickeEcke4_2_St_4_SBSBS: wanddickeEcke4_2_St_4_SBSBS,
              positionEcke4_2_St_4_SBSBS: positionEcke4_2_St_4_SBSBS,
              wanddickeEcke5_2_St_4_SBSBS: wanddickeEcke5_2_St_4_SBSBS,
              positionEcke5_2_St_4_SBSBS: positionEcke5_2_St_4_SBSBS,
              wanddickeEcke6_2_St_4_SBSBS: wanddickeEcke6_2_St_4_SBSBS,
              positionEcke6_2_St_4_SBSBS: positionEcke6_2_St_4_SBSBS,
              // wanddickeEcke7Zwischen9_2_St_4_SBSBS,
              // positionEcke7Zwischen9_2_St_4_SBSBS,
              wanddickeEcke7_2_St_4_SBSBS: wanddickeEcke7_2_St_4_SBSBS,
              positionEcke7_2_St_4_SBSBS: positionEcke7_2_St_4_SBSBS,
              wanddickeEcke8_2_St_4_SBSBS: wanddickeEcke8_2_St_4_SBSBS,
              positionEcke8_2_St_4_SBSBS: positionEcke8_2_St_4_SBSBS,
              wanddickeEcke9_2_St_4_SBSBS: wanddickeEcke9_2_St_4_SBSBS,
              positionEcke9_2_St_4_SBSBS: positionEcke9_2_St_4_SBSBS,
              wanddickeEckeEnde_2_St_4_SBSBS: wanddickeEckeEnde_2_St_4_SBSBS,
              positionEckeEnde_2_St_4_SBSBS: positionEckeEnde_2_St_4_SBSBS
            };
            (0, _recipes.createRecipe2_St_4_SBSBS)(data_2_St_4_SBSBS);
          case 51:
          case "end":
            return _context9.stop();
        }
...
if (createRecipe2_St_2_BSB_DataForm) {
  createRecipe2_St_2_BSB_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(e) {
      var artikelNummer_2_St_2_BSB, artikelName_2_St_2_BSB, vDornVor_2_St_2_BSB, vDornZurueck_2_St_2_BSB, ziehGeschwindigkeit_2_St_2_BSB, benutzerVorName_2_St_2_BSB, benutzerNachName_2_St_2_BSB, rohrAussenDurchmesserLetzterZug_2_St_2_BSB, rohrWandDickeAussenDurchmesserLetzterZug_2_St_2_BSB, rohrInnenDurchmesserLetzterZugBerechnet_2_St_2_BSB, rohrAussenDurchmesserTDTZug_2_St_2_BSB, angel_2_St_2_BSB, dornDurchmesserErsteStufe_2_St_2_BSB, dornPositionErsteStufe_2_St_2_BSB, dornDurchmesserZweiteStufe_2_St_2_BSB, dornPositionZweiteStufe_2_St_2_BSB, fixlaenge_2_St_2_BSB, ausgleichstueck_2_St_2_BSB, mehrfachlaenge_2_St_2_BSB, anzahlFixlaengenProMehrfachlaenge_2_St_2_BSB, mindestGutanteil_2_St_2_BSB, profileGekoppelt_2_St_2_BSB, obereToleranz_2_St_2_BSB, untereToleranz_2_St_2_BSB, wanddickeEcke0_2_St_2_BSB, positionEcke0_2_St_2_BSB, wanddickeEcke1_2_St_2_BSB, positionEcke1_2_St_2_BSB, wanddickeEcke2_2_St_2_BSB, positionEcke2_2_St_2_BSB, wanddickeEcke3_2_St_2_BSB, positionEcke3_2_St_2_BSB, wanddickeEcke4_2_St_2_BSB, positionEcke4_2_St_2_BSB, wanddickeEckeEnde_2_St_2_BSB, positionEckeEnde_2_St_2_BSB, benutzerID_2_St_2_BSB, data_2_St_2_BSB;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            console.log('bin createRecipe2_St_2_BSB_DataForm in index.js');
            e.preventDefault();
            artikelNummer_2_St_2_BSB = document.getElementById('artikelNummer').value;
            artikelName_2_St_2_BSB = document.getElementById('artikelName').value;
            vDornVor_2_St_2_BSB = document.getElementById('vDornVor').value;
            vDornZurueck_2_St_2_BSB = document.getElementById('vDornZurueck').value;
            console.log('vDornVor_2_St_2_BSB:', vDornVor_2_St_2_BSB);
            console.log('vDornZurueck_2_St_2_BSB:', vDornZurueck_2_St_2_BSB);
            ziehGeschwindigkeit_2_St_2_BSB = document.getElementById('ziehGeschwindigkeit').value;
            benutzerVorName_2_St_2_BSB = document.getElementById('benutzerVorName').value;
            benutzerNachName_2_St_2_BSB = document.getElementById('benutzerNachName').value;
            rohrAussenDurchmesserLetzterZug_2_St_2_BSB = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug_2_St_2_BSB = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet_2_St_2_BSB = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug_2_St_2_BSB = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel_2_St_2_BSB = document.getElementById('angel').value;
            dornDurchmesserErsteStufe_2_St_2_BSB = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe_2_St_2_BSB = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe_2_St_2_BSB = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe_2_St_2_BSB = document.getElementById('dornPositionZweiteStufe').value;
            fixlaenge_2_St_2_BSB = document.getElementById('fixlaenge').value;
            ausgleichstueck_2_St_2_BSB = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge_2_St_2_BSB = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge_2_St_2_BSB = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil_2_St_2_BSB = document.getElementById('mindestGutanteil').value;
            profileGekoppelt_2_St_2_BSB = document.getElementById('profileGekoppelt').value;
            obereToleranz_2_St_2_BSB = document.getElementById('obereToleranz').value;
            untereToleranz_2_St_2_BSB = document.getElementById('untereToleranz').value;
            wanddickeEcke0_2_St_2_BSB = document.getElementById('wanddickeEcke0').value;
            positionEcke0_2_St_2_BSB = document.getElementById('positionEcke0').value;
            wanddickeEcke1_2_St_2_BSB = document.getElementById('wanddickeEcke1').value;
            positionEcke1_2_St_2_BSB = document.getElementById('positionEcke1').value;
            wanddickeEcke2_2_St_2_BSB = document.getElementById('wanddickeEcke2').value;
            positionEcke2_2_St_2_BSB = document.getElementById('positionEcke2').value;
            wanddickeEcke3_2_St_2_BSB = document.getElementById('wanddickeEcke3').value;
            positionEcke3_2_St_2_BSB = document.getElementById('positionEcke3').value; // const wanddickeEcke3Zwischen4_2_St_2_BSB = document.getElementById(
            //   'wanddickeEcke3Zwischen4',
            // ).value;
            // const positionEcke3Zwischen4_2_St_2_BSB = document.getElementById(
            //   'positionEcke3Zwischen4',
            // ).value;
            wanddickeEcke4_2_St_2_BSB = document.getElementById('wanddickeEcke4').value;
            positionEcke4_2_St_2_BSB = document.getElementById('positionEcke4').value;
            wanddickeEckeEnde_2_St_2_BSB = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde_2_St_2_BSB = document.getElementById('positionEckeEnde').value;
            benutzerID_2_St_2_BSB = document.getElementById('benutzerID').value; // console.log('artikelNummer: ' + artikelNummer);
            // console.log('artikelName: ' + artikelName);
            data_2_St_2_BSB = {
              artikelNummer_2_St_2_BSB: artikelNummer_2_St_2_BSB,
              artikelName_2_St_2_BSB: artikelName_2_St_2_BSB,
              ziehGeschwindigkeit_2_St_2_BSB: ziehGeschwindigkeit_2_St_2_BSB,
              vDornVor_2_St_2_BSB: vDornVor_2_St_2_BSB,
              vDornZurueck_2_St_2_BSB: vDornZurueck_2_St_2_BSB,
              benutzerVorName_2_St_2_BSB: benutzerVorName_2_St_2_BSB,
              benutzerNachName_2_St_2_BSB: benutzerNachName_2_St_2_BSB,
              benutzerID_2_St_2_BSB: benutzerID_2_St_2_BSB,
              rohrAussenDurchmesserLetzterZug_2_St_2_BSB: rohrAussenDurchmesserLetzterZug_2_St_2_BSB,
              rohrWandDickeAussenDurchmesserLetzterZug_2_St_2_BSB: rohrWandDickeAussenDurchmesserLetzterZug_2_St_2_BSB,
              rohrInnenDurchmesserLetzterZugBerechnet_2_St_2_BSB: rohrInnenDurchmesserLetzterZugBerechnet_2_St_2_BSB,
              rohrAussenDurchmesserTDTZug_2_St_2_BSB: rohrAussenDurchmesserTDTZug_2_St_2_BSB,
              angel_2_St_2_BSB: angel_2_St_2_BSB,
              dornDurchmesserErsteStufe_2_St_2_BSB: dornDurchmesserErsteStufe_2_St_2_BSB,
              dornPositionErsteStufe_2_St_2_BSB: dornPositionErsteStufe_2_St_2_BSB,
              dornDurchmesserZweiteStufe_2_St_2_BSB: dornDurchmesserZweiteStufe_2_St_2_BSB,
              dornPositionZweiteStufe_2_St_2_BSB: dornPositionZweiteStufe_2_St_2_BSB,
              fixlaenge_2_St_2_BSB: fixlaenge_2_St_2_BSB,
              ausgleichstueck_2_St_2_BSB: ausgleichstueck_2_St_2_BSB,
              mehrfachlaenge_2_St_2_BSB: mehrfachlaenge_2_St_2_BSB,
              anzahlFixlaengenProMehrfachlaenge_2_St_2_BSB: anzahlFixlaengenProMehrfachlaenge_2_St_2_BSB,
              mindestGutanteil_2_St_2_BSB: mindestGutanteil_2_St_2_BSB,
              profileGekoppelt_2_St_2_BSB: profileGekoppelt_2_St_2_BSB,
              obereToleranz_2_St_2_BSB: obereToleranz_2_St_2_BSB,
              untereToleranz_2_St_2_BSB: untereToleranz_2_St_2_BSB,
              wanddickeEcke0_2_St_2_BSB: wanddickeEcke0_2_St_2_BSB,
              positionEcke0_2_St_2_BSB: positionEcke0_2_St_2_BSB,
              wanddickeEcke1_2_St_2_BSB: wanddickeEcke1_2_St_2_BSB,
              positionEcke1_2_St_2_BSB: positionEcke1_2_St_2_BSB,
              wanddickeEcke2_2_St_2_BSB: wanddickeEcke2_2_St_2_BSB,
              positionEcke2_2_St_2_BSB: positionEcke2_2_St_2_BSB,
              wanddickeEcke3_2_St_2_BSB: wanddickeEcke3_2_St_2_BSB,
              positionEcke3_2_St_2_BSB: positionEcke3_2_St_2_BSB,
              // wanddickeEcke3Zwischen4_2_St_2_BSB,
              // positionEcke3Zwischen4_2_St_2_BSB,
              wanddickeEcke4_2_St_2_BSB: wanddickeEcke4_2_St_2_BSB,
              positionEcke4_2_St_2_BSB: positionEcke4_2_St_2_BSB,
              wanddickeEckeEnde_2_St_2_BSB: wanddickeEckeEnde_2_St_2_BSB,
              positionEckeEnde_2_St_2_BSB: positionEckeEnde_2_St_2_BSB
            };
            (0, _recipes.createRecipe2_St_2_BSB)(data_2_St_2_BSB);
          case 43:
          case "end":
            return _context10.stop();
        }
...
var saveUpdateRecipeButton = document.querySelector('.btn--saveUpdateRecipe');
var deleteRecipeButton = document.querySelector('.btn--deleteRecipe');
if (updateRecipeDataForm) {
  console.log('bin updateRecipeDataForm ---1---');
  updateRecipeDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    var userNewDate = document.getElementById('userNewDate').value;
    console.log('userNewDate: ' + userNewDate);
    var artikelNummerUpdate = parseFloat(document.getElementById('artikelNummer').value);
    console.log('artikelNummerUpdate: ' + artikelNummerUpdate);

    //TODO: Name muss sich mehrfachlänge und anzahl fixlänge verändern!!
    var artikelNameOLDtoChangeForUpdate = document.getElementById('artikelName').value;
    console.log('artikelNameOLDtoChangeForUpdate: ' + artikelNameOLDtoChangeForUpdate);
    var artikelNameSplit = artikelNameOLDtoChangeForUpdate.split(' ');
    var artikelNameUpdateOLD = artikelNameSplit[0];
    console.log('artikelNameUpdateOLD: ' + artikelNameUpdateOLD);
    var ziehGeschwindigkeitUpdate = document.getElementById('ziehGeschwindigkeit').value;
    console.log('ziehGeschwindigkeitUpdate: ' + ziehGeschwindigkeitUpdate);
    var commentDropdown = document.getElementById('commentDropdown').value;
    console.log('commentDropdown: ' + commentDropdown);
    var customCommentInput = document.getElementById('customCommentInput').value;
    ...
    var vDornVorUpdate = document.getElementById('vDornVor').value;
    console.log('vDornVorUpdate:', vDornVorUpdate);
    var vDornZurueckUpdate = document.getElementById('vDornZurueck').value;
    console.log('vDornZurueckUpdate:', vDornZurueckUpdate);
    var teileNummerUpdate = document.getElementById('teileNummer').value;
    ...
    var zeichnungsNummerUpdate = document.getElementById('zeichnungsNummer').value;
    console.log('zeichnungsNummerUpdate: ' + zeichnungsNummerUpdate);
    var aenderungsstandZeichnungUpdate = parseFloat(document.getElementById('aenderungsstandZeichnung').value);
    console.log('aenderungsstandZeichnungUpdate: ' + aenderungsstandZeichnungUpdate);
    var aenderungsstandRezeptUpdate = parseFloat(document.getElementById('aenderungsstandRezept').value);
    console.log('aenderungsstandRezeptUpdate: ' + aenderungsstandRezeptUpdate);
    var beschreibungUpdate = document.getElementById('beschreibung').value;
    console.log('beschreibungUpdate: ' + beschreibungUpdate);
    var mindestGutanteilUpdate = parseFloat(document.getElementById('mindestGutanteil').value);
    console.log('mindestGutanteilUpdate: ' + mindestGutanteilUpdate);
    var profileGekoppeltUpdate = parseFloat(document.getElementById('profileGekoppelt').value);
    console.log('profileGekoppeltUpdate: ' + profileGekoppeltUpdate);
    var rohrAussenDurchmesserLetzterZugUpdate = parseFloat(document.getElementById('rohrAussenDurchmesserLetzterZug').value);
    console.log('rohrAussenDurchmesserLetzterZugUpdate: ' + rohrAussenDurchmesserLetzterZugUpdate);
    var rohrInnenDurchmesserLetzterZugUpdate = parseFloat(document.getElementById('rohrInnenDurchmesserLetzterZug').value);
    console.log('rohrInnenDurchmesserLetzterZugUpdate: ' + rohrInnenDurchmesserLetzterZugUpdate);
    var angelUpdate = parseFloat(document.getElementById('angel').value);
    console.log('angelUpdate: ' + angelUpdate);
    var rohrAussenDurchmesserTDTZugUpdate = parseFloat(document.getElementById('rohrAussenDurchmesserTDTZug').value);
    console.log('rohrAussenDurchmesserTDTZugUpdate: ' + rohrAussenDurchmesserTDTZugUpdate);
    var dornStufenContainer = document.querySelectorAll('.dornStufen-Container');
    var dornStufenDataUpdate = [];
    dornStufenContainer.forEach(function (container) {
      console.log('container: ' + container);
      var stufeID = container.querySelector('.stufeID').value;
      var dornDurchmesser = container.querySelector('.dornDurchmesser').value;
      var position = container.querySelector('.position').value;
      var rampeRein = container.querySelector('.rampeRein').value;
      var rampeRaus = container.querySelector('.rampeRaus').value;
      var dehnung = container.querySelector('.dehnung').value;
      var stufeData = {
        id: stufeID,
    ...
    console.log('JSON.stringify(dornStufenData): ' + JSON.stringify(dornStufenDataUpdate));
    dornStufenDataUpdate.forEach(function (stufe) {
      console.log('Stufe: ' + stufe);
      console.log('JSON.stringify(stufe): ' + JSON.stringify(stufe));
    });
    var fixlaengeUpdate = parseFloat(document.getElementById('fixlaenge').value);
    console.log('fixlaengeUpdate: ' + fixlaengeUpdate);
    var ausgleichstueckUpdate = parseFloat(document.getElementById('ausgleichstueck').value);
    console.log('ausgleichstueckUpdate: ' + ausgleichstueckUpdate);
    var mehrfachlaengeUpdate = parseFloat(document.getElementById('mehrfachlaenge').value);
    console.log('mehrfachlaengeUpdate: ' + mehrfachlaengeUpdate);
    var anzahlFixlaengenProMehrfachlaengeUpdate = parseFloat(document.getElementById('anzahlFixlaengenProMehrfachlaenge').value);
    console.log('anzahlFixlaengenProMehrfachlaengeUpdate: ' + anzahlFixlaengenProMehrfachlaengeUpdate);
    var negativeToleranzMehrfachlaengeUpdate = parseFloat(document.getElementById('negativeToleranzMehrfachlaenge').value);
    console.log('negativeToleranzMehrfachlaengeUpdate: ' + negativeToleranzMehrfachlaengeUpdate);
    var positiveToleranzMehrfachlaengeUpdate = parseFloat(document.getElementById('positiveToleranzMehrfachlaenge').value);
    console.log('positiveToleranzMehrfachlaengeUpdate: ' + positiveToleranzMehrfachlaengeUpdate);
    var mindestanzahlGutprofileUpdate = parseFloat(document.getElementById('mindestanzahlGutprofile').value);
    console.log('mindestanzahlGutprofileUpdate: ' + mindestanzahlGutprofileUpdate);
    var obereToleranzUpdate = parseFloat(document.getElementById('obereToleranz').value);
    console.log('obereToleranzUpdate: ' + obereToleranzUpdate);
    var untereToleranzUpdate = parseFloat(document.getElementById('untereToleranz').value);
    ...
    // };
    //---------------------------------------------------------------
    var eckenInputs = document.querySelectorAll('.eckeInputs');
    var eckenDataUpdate = [];
    eckenInputs.forEach(function (eckeInput, index) {
      var eckeID = eckeInput.querySelector('.eckeID').value;
      console.log('Ecke ID ' + index + ': ' + eckeID);
      var eckeXPosition = eckeInput.querySelector('.eckeXPosition').value;
      console.log('Ecke X-Position ' + index + ': ' + eckeXPosition);
      var eckeZWanddicke = eckeInput.querySelector('.eckeZWanddicke').value;
    ...
    console.log('JSON.stringify(eckenDataUpdate): ' + JSON.stringify(eckenDataUpdate));
    eckenDataUpdate.forEach(function (ecke) {
    ...
    if (e.submitter === saveUpdateRecipeButton) {
      ...
      (0, _recipes.updateRecipe)({
        artikelNummerUpdate: artikelNummerUpdate,
        artikelNameUpdateOLD: artikelNameUpdateOLD,
        ziehGeschwindigkeitUpdate: ziehGeschwindigkeitUpdate,
        commentUpdate: commentUpdate,
        userID: userID,
        vDornVorUpdate: vDornVorUpdate,
        vDornZurueckUpdate: vDornZurueckUpdate,
        teileNummerUpdate: teileNummerUpdate,
        zeichnungsNummerUpdate: zeichnungsNummerUpdate,
        aenderungsstandZeichnungUpdate: aenderungsstandZeichnungUpdate,
        aenderungsstandRezeptUpdate: aenderungsstandRezeptUpdate,
        beschreibungUpdate: beschreibungUpdate,
        mindestGutanteilUpdate: mindestGutanteilUpdate,
        profileGekoppeltUpdate: profileGekoppeltUpdate,
        rohrAussenDurchmesserLetzterZugUpdate: rohrAussenDurchmesserLetzterZugUpdate,
        rohrInnenDurchmesserLetzterZugUpdate: rohrInnenDurchmesserLetzterZugUpdate,
        angelUpdate: angelUpdate,
        rohrAussenDurchmesserTDTZugUpdate: rohrAussenDurchmesserTDTZugUpdate,
        dornStufenDataUpdate: dornStufenDataUpdate,
        fixlaengeUpdate: fixlaengeUpdate,
        ausgleichstueckUpdate: ausgleichstueckUpdate,
        mehrfachlaengeUpdate: mehrfachlaengeUpdate,
        anzahlFixlaengenProMehrfachlaengeUpdate: anzahlFixlaengenProMehrfachlaengeUpdate,
        negativeToleranzMehrfachlaengeUpdate: negativeToleranzMehrfachlaengeUpdate,
        positiveToleranzMehrfachlaengeUpdate: positiveToleranzMehrfachlaengeUpdate,
        mindestanzahlGutprofileUpdate: mindestanzahlGutprofileUpdate,
        obereToleranzUpdate: obereToleranzUpdate,
        untereToleranzUpdate: untereToleranzUpdate,
        eckenDataUpdate: eckenDataUpdate
      }, recipeID);
    } else if (e.submitter === deleteRecipeButton) {
      console.log('bin Delete in updateRecipeDataForm');
      (0, _recipes.deleteRecipe)(recipeID);
    }
  });
}
if (dragDropForm) dragDropForm.addEventListener('submit', function (e) {
  e.preventDefault(); // element prevent from loading the page

  console.log('bin dragDropForm in index.js');
  var inputOldRecipes = document.getElementById('hiddenRecipesField').value;
