...
//TODO: recipeSPS originalID wenn löschen, auf null setzen!
// wenn rezept gelöscht wird, muss die originalID auch in recipeSPS auf null gesetzt werden, wegen verweisung!
// recipeSchema.pre('deleteOne', async function(next) {
//   const recipeId = this.getQuery()["_id"]; // Holen der ID des zu löschenden Rezepts

//   // Alle `RecipesSPS_de`-Dokumente, die auf dieses Rezept verweisen, bereinigen
//   await mongoose.model('RecipesSPS_de').updateMany(
//     { "recipeSend_recipeOriginalID": recipeId },
//     { $set: { "recipeSend_recipeOriginalID": null } }
//   );

//   next(); // Middleware fortsetzen
// });
